...
export const A339Payload: React.FC<PayloadProps> = ({
    airframeInfo,
    flypadInfo,
    cabinInfo,
    maxPax,
    ...
    const [bFlags] = useSeatFlags(`L:${cabinInfo.seatMap[1].simVar}`, cabinInfo.seatMap[1].capacity, 521);
    const [cFlags] = useSeatFlags(`L:${cabinInfo.seatMap[2].simVar}`, cabinInfo.seatMap[2].capacity, 523);
    const [dFlags] = useSeatFlags(`L:${cabinInfo.seatMap[3].simVar}`, cabinInfo.seatMap[3].capacity, 541);
    const [eFlags] = useSeatFlags(`L:${cabinInfo.seatMap[4].simVar}`, cabinInfo.seatMap[4].capacity, 547);
    const [fFlags] = useSeatFlags(`L:${cabinInfo.seatMap[5].simVar}`, cabinInfo.seatMap[5].capacity, 557);
    const [gFlags] = useSeatFlags(`L:${cabinInfo.seatMap[6].simVar}`, cabinInfo.seatMap[6].capacity, 563);
    const [hFlags] = useSeatFlags(`L:${cabinInfo.seatMap[7].simVar}`, cabinInfo.seatMap[7].capacity, 569);
    const [iFlags] = useSeatFlags(`L:${cabinInfo.seatMap[8].simVar}`, cabinInfo.seatMap[8].capacity, 571);
    const [jFlags] = useSeatFlags(`L:${cabinInfo.seatMap[9].simVar}`, cabinInfo.seatMap[9].capacity, 577);

    const [aFlagsDesired, setAFlagsDesired] = useSeatFlags(`L:${cabinInfo.seatMap[0].simVar}_DESIRED`, cabinInfo.seatMap[0].capacity, 317);
    const [bFlagsDesired, setBFlagsDesired] = useSeatFlags(`L:${cabinInfo.seatMap[1].simVar}_DESIRED`, cabinInfo.seatMap[1].capacity, 347);
    const [cFlagsDesired, setCFlagsDesired] = useSeatFlags(`L:${cabinInfo.seatMap[2].simVar}_DESIRED`, cabinInfo.seatMap[2].capacity, 359);
    const [dFlagsDesired, setDFlagsDesired] = useSeatFlags(`L:${cabinInfo.seatMap[3].simVar}_DESIRED`, cabinInfo.seatMap[3].capacity, 379);
    const [eFlagsDesired, setEFlagsDesired] = useSeatFlags(`L:${cabinInfo.seatMap[4].simVar}_DESIRED`, cabinInfo.seatMap[4].capacity, 397);
    const [fFlagsDesired, setFFlagsDesired] = useSeatFlags(`L:${cabinInfo.seatMap[5].simVar}_DESIRED`, cabinInfo.seatMap[5].capacity, 421);
    const [gFlagsDesired, setGFlagsDesired] = useSeatFlags(`L:${cabinInfo.seatMap[6].simVar}_DESIRED`, cabinInfo.seatMap[6].capacity, 439);
    const [hFlagsDesired, setHFlagsDesired] = useSeatFlags(`L:${cabinInfo.seatMap[7].simVar}_DESIRED`, cabinInfo.seatMap[7].capacity, 457);
    const [iFlagsDesired, setIFlagsDesired] = useSeatFlags(`L:${cabinInfo.seatMap[8].simVar}_DESIRED`, cabinInfo.seatMap[8].capacity, 479);
    const [jFlagsDesired, setJFlagsDesired] = useSeatFlags(`L:${cabinInfo.seatMap[9].simVar}_DESIRED`, cabinInfo.seatMap[9].capacity, 499);

    const activeFlags = useMemo(() => [aFlags, bFlags, cFlags, dFlags, eFlags, fFlags, gFlags, hFlags, iFlags, jFlags], [aFlags, bFlags, cFlags, dFlags, eFlags, fFlags, gFlags, hFlags, iFlags, jFlags]);
    const desiredFlags = useMemo(() => [aFlagsDesired, bFlagsDesired, cFlagsDesired, dFlagsDesired, eFlagsDesired, fFlagsDesired, gFlagsDesired, hFlagsDesired, iFlagsDesired, jFlagsDesired], [aFlagsDesired, bFlagsDesired, cFlagsDesired, dFlagsDesired, eFlagsDesired, fFlagsDesired, gFlagsDesired, hFlagsDesired, iFlagsDesired, jFlagsDesired]);
    const setDesiredFlags = useMemo(() => [setAFlagsDesired, setBFlagsDesired, setCFlagsDesired, setDFlagsDesired, setEFlagsDesired, setFFlagsDesired, setGFlagsDesired, setHFlagsDesired, setIFlagsDesired, setJFlagsDesired], []);
