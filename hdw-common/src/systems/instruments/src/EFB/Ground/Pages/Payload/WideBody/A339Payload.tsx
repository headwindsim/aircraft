...
export const A339Payload: React.FC<PayloadProps> = ({
  ...
  const activeFlags = useMemo(
    () => [aFlags, bFlags, cFlags, dFlags, eFlags, fFlags, gFlags, hFlags, iFlags, jFlags],
    [aFlags, bFlags, cFlags, dFlags, eFlags, fFlags, gFlags, hFlags, iFlags, jFlags],
  );
