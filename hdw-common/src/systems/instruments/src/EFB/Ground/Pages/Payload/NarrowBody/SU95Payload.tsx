...
import { SeatOutlineBg } from '../../../../Assets/SU95SeatOutlineBg';
...
export const SU95Payload: React.FC<PayloadProps> = ({
    airframeInfo,
    flypadInfo,
    cabinInfo,
    maxPax,
    ...
    }, [totalPaxDesired, totalPax, totalCargoDesired, totalCargo, cabinLeftDoorOpen, cabinRightDoorOpen, aftLeftDoorOpen, midRightDoorOpen, boardingRate]);
