...
export const SU95Payload: React.FC<PayloadProps> = ({
  ...
  const desiredFlags = useMemo(
    () => [aFlagsDesired, bFlagsDesired, cFlagsDesired, dFlagsDesired, eFlagsDesired],
    [aFlagsDesired, bFlagsDesired, cFlagsDesired, dFlagsDesired, eFlagsDesired],
  );
  const setDesiredFlags = useMemo(
    () => [setAFlagsDesired, setBFlagsDesired, setCFlagsDesired, setDFlagsDesired, setEFlagsDesired],
    [],
  );
