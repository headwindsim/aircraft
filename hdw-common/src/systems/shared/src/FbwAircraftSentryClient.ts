...
export class FbwAircraftSentryClient {
  ...
  static async requestConsent() {
    ...
    return new Promise<boolean>((resolve) => {
      popup.showPopUp(
        ...
        'Are you willing to help Headwind Simulations by enabling anonymous reporting of errors that may occur in the future? ' +
  ...
  private static async initializeSentry(config: FbwAircraftSentryClientConfiguration) {
    ...
    NXDataStore.getAndSubscribeLegacy('SENTRY_SESSION_ID', (_, value) => {
      if (value) {
