        ...
        <g id="SVG_Detail_Lines">
                    ...
                    <g id="Engine_Mount">
                        ...
                        <g id="Mounts">
                            ...
                            <path
                                id="Right_Mount"
                                className="cls-5"
                                d="M267.39 295.9v-37.42"
                            />
                            <path
                                id="Front_Mount"
                                className="cls-5"
                                d="M255.06 260.72h12.33"
                            />
                        </g>
                    </g>
                    <path
                ...
                <g id="ENG_2">
                    ...
                    <g id="Reverser_Door-2">
                        <path
                            id="Outer_Side-2"
                            className="cls-5"
                            d="M519.72 295.91c7.92 0 14.42-.09 19.83-.7"
                        />
                        <path
                            id="Inner_Side-2"
                            className="cls-5"
                            d="M511.05 295.91c-7.92 0-14.42-.09-19.83-.7"
                        />
                    </g>
                    <g id="Engine_Mount-2">
                        <g id="Connections-2">
                        ...
                        <g id="Mounts-2">
                            <path
                                id="Right_Mount-2"
                                className="cls-5"
                                d="M521.58 295.9v-37.5"
                            />
                            <path
                                id="Left_Mount-2"
                                className="cls-5"
                                d="M509.25 295.9v-37.42"
                            />
                            <path
                                id="Front_Mount-2"
                                className="cls-5"
                                d="M521.58 260.72h-12.33"
                            />
                        </g>
                    </g>
                    <path
                        id="Wing_Mount-2"
                        className="cls-5"
                        d="m503.99 321.82 7.61 3.97 9.15 8.61"
                    />
                </g>
            </g>
            <g id="Emergency_Lines">
                <path
                    ...
                    className="cls-5"
                    d="M346.2 307h-20.55a6.31 6.31 0 0 0-6.31 6.31v84.6"
                />
                <path
                    id="Right_Emergency_Marks"
                    className="cls-5"
                    d="M430.18 307h20.55a6.31 6.31 0 0 1 6.31 6.31v84.6"
                />
            </g>
            <g id="Wing_Layers">
                <path
                    ...
                    className="cls-5"
                    d="M346.2 292.33 35.36 449.78v11.89l219.86-87.34 64.11-12.21"
                />
                <path
            ...
            <g id="Doors">
                ...
                <g id="Cargo_Doors">
                    ...
                    <g id="AFT_Cargo">
                        <path className="cls-2" d="M430.18 530h-2" />
                        <path
                            d="M424.16 530h-14.91c-1.98 0-3.58-1.6-3.58-3.58v-27.33c0-1.98 1.6-3.58 3.58-3.58h17.02"
                            style={{
                    ...
                    <g id="FWD_Cargo">
                        <path className="cls-2" d="M430.28 140.67h-2" />
                        <path
                            d="M424.2 140.67h-15.17c-2.13 0-3.86 1.73-3.86 3.86v26.94c0 2.13 1.73 3.86 3.86 3.86h17.21"
                            style={{
        ...
        <g id="SVG_Main_Lines">
                ...
                <g id="Right_Wing">
                    <g id="Right_Slats">
                        ...
                        <g id="Main_Slats">
                            ...
                            <path
                                id="Inner_Divider"
                                className="cls-1"
                                d="m582.46 368.11 3.63-6.92"
                            />
                            <path
                                id="Main_Slats_Outline"
                                className="cls-1"
                                d="m740.33 441.28-3.3 4.89-216.28-109.23v-9.72"
                            />
                        </g>
                    </g>
                    <g id="Right_Wing_Flap_Fairings">
                        ...
                        <path
                            id="Inner"
                            className="cls-1"
                            d="M490.43 409.89c0 6.63 3.2 15.28 3.2 15.28s2.71-9.28 2.71-15.28"
                        />
                    </g>
                    <g id="Right_Flaps">
                        <path
                            id="Flap_Divider"
                            className="cls-1"
                            d="M527.05 410.11v-11.35"
                        />
                        <path
                            id="Flap_Outline"
                            className="cls-1"
                            d="M430.28 397.92h94.45l156.08 56.58v3.63"
                        />
                    </g>
                    <g id="Right_Spoilers">
                        <path
                            id="Inner_Spoiler"
                            className="cls-1"
                            d="M494.37 397.92V384h30.34l.08 13.92"
                        />
                        <g id="Main_Spoilers">
                            <path
                                id="Outer_Divider-2"
                                className="cls-1"
                                d="m639.29 439.42 4.96-13.81"
                            />
                            <path
                                id="Middle_Divider-2"
                                className="cls-1"
                                d="m606.89 427.68 5.25-13.7"
                            />
                            <path
                                id="Inner_Divider-2"
                                className="cls-1"
                                d="m570.46 414.47 5.34-13.65"
                            />
                            <path
                                id="Main_Spoiler_Outline"
                                className="cls-1"
                                d="m534.5 401.44 6.37-13.27 135.75 49.16-4.68 13.93"
                            />
                        </g>
                    </g>
                    <path
                        id="Right_Aileron"
                        className="cls-1"
                        d="M742.29 476.96v-13.35l-56.26-20.22-1.39 2.78v12.73"
                    />
                    <g id="ENG_2-2">
                        <path
                            id="Engine_Mount-3"
                        ...
                        <path
                            id="Exhaust"
                            className="cls-1"
                            d="M530.05 320.06s-1.97 8.42-3.34 10"
                        />
                        <path
                            id="Engine_Inner_end"
                            className="cls-4"
                            d="M507.45 320.06h3.6"
                        />
                        <path
                            id="Cowling"
                            className="cls-1"
                            d="M493.6 255.65c0-4.06 43.58-4.06 43.58 0"
                        />
                    </g>
                    <path
                ...
                <g id="Left_Wing">
                    <g id="Left_Slats">
                        <path
                            id="Inner_Slats-2"
                            className="cls-1"
                            d="M339.62 283.52v10.37L275.5 327l-4.57-7.85"
                        />
                        <g id="Main_Slats-2">
                            <path
                                id="Outer_Divider-3"
                                className="cls-1"
                                d="m83.92 423.46-3.3-5.59"
                            />
                            <path
                                id="Middle_Divider-3"
                                className="cls-1"
                                d="m138.89 395.69-3.78-6.09"
                            />
                            <path
                                id="Inner_Divider-3"
                                className="cls-1"
                                d="m193.51 368.11-3.62-6.92"
                            />
                            <path
                                id="Main_Slats_Outline-2"
                                className="cls-1"
                                d="m35.65 441.28 3.29 4.89 216.28-109.23v-9.72"
                            />
                        </g>
                    </g>
                    <g id="Left_Wing_Flap_Fairings">
                        ...
                        <path
                            id="Inner-2"
                            className="cls-1"
                            d="M286.05 409.89c0 6.63-3.2 15.28-3.2 15.28s-2.71-9.28-2.71-15.28"
                        />
                    </g>
                    <g id="Left_Flaps">
                        <path
                            id="Flap_Divider-2"
                            className="cls-1"
                            d="M249.43 410.11v-11.35"
                        />
                        <path
                            id="Flap_Outline-2"
                            className="cls-1"
                            d="M346.2 397.92h-94.45L95.67 454.5v3.63"
                        />
                    </g>
                    <g id="Left_Spoilers">
                        <path
                            id="Inner_Spoiler-2"
                            className="cls-1"
                            d="M282.17 397.92V384h-30.34l-.08 13.92"
                        />
                        <g id="Main_Spoilers-2">
                            <path
                                id="Outer_Divider-4"
                                className="cls-1"
                                d="m137.25 439.42-4.96-13.81"
                            />
                            <path
                                id="Middle_Divider-4"
                                className="cls-1"
                                d="m169.65 427.68-5.25-13.7"
                            />
                            <path
                                id="Inner_Divider-4"
                                className="cls-1"
                                d="m206.08 414.47-5.34-13.65"
                            />
                            <path
                    ...
                    <path
                        id="Left_Aileron"
                        className="cls-1"
                        d="M35.36 476.96v-13.35l56.25-20.22 1.39 2.78v12.73"
                    />
                    <g id="ENG_1-2">
                        <path
                            id="Engine_Mount-4"
                        ...
                        <path
                            id="Exhaust-2"
                            className="cls-1"
                            d="M246.58 320.06s1.97 8.42 3.34 10"
                        />
                        <path
                            id="Engine_Inner_end-2"
                            className="cls-4"
                            d="M269.19 320.06h-3.61"
                        />
                        <path
                            id="Cowling-2"
                            className="cls-1"
                            d="M239.46 255.65c0-4.06 43.58-4.06 43.58 0"
                        />
                    </g>
                    <path
            ...
            <g id="Fuselage">
                <path
                    id="APU_Exhaust"
                    className="cls-1"
                    d="m384.38 809.8.59-.08c2.34-.3 4.71-.28 7.04.06h.08"
                />
