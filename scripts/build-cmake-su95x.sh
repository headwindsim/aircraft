...
SU95X_WASM_OUT_DIR="../build-su95x/out/headwindsim-aircraft-su100-95/SimObjects/Airplanes/Headwind_SU95/panel"
if [ ! -d "$SU95X_WASM_OUT_DIR" ]; then
  echo "$SU95X_WASM_OUT_DIR directory does not exist."
  mkdir -p $SU95X_WASM_OUT_DIR
  echo "$SU95X_WASM_OUT_DIR directory created."
fi
