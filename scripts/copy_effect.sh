...
rm -rf ./hdw-a339x/src/base/headwindsim-aircraft-a330-900/effects

cp -ra ./flybywire/fbw-a32nx/src/base/flybywire-aircraft-a320-neo/effects/. ./hdw-a339x/src/base/headwindsim-aircraft-a330-900/effects
