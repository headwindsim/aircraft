...
# copy submodule large-files to build out folder
cp -ra ./large-files/hdw-a339x/src/base/headwindsim-aircraft-a330-900/. ./build-a339x/out/headwindsim-aircraft-a330-900
