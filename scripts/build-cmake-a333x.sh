...
A333X_WASM_OUT_DIR="../build-a333x/out/headwindsim-aircraft-a330-300/SimObjects/Airplanes/Headwind_A330_300/panel"
if [ ! -d "$A333X_WASM_OUT_DIR" ]; then
  echo "$A333X_WASM_OUT_DIR directory does not exist."
  mkdir -p $A333X_WASM_OUT_DIR
  echo "$A333X_WASM_OUT_DIR directory created."
fi
