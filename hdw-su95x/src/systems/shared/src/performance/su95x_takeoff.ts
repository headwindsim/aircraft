 ...
 */
export class SSJ10095TakeoffPerformanceCalculator implements TakeoffPerformanceCalculator {
  ...
  public calculateTakeoffPerformance(
    ...
    result.params = {
      adjustedTora: tora - (SSJ10095TakeoffPerformanceCalculator.lineUpDistances[lineupAngle] ?? 0),
      pressureAlt,
      isaTemp,
      tRef,
      tMax,
    ...
    if (result.error === TakeoffPerfomanceError.None) {
      ...
      if (runwayCondition === RunwayCondition.Dry) {
        ...
        const factors: ReadonlyFloat64Array = (
          result.inputs.oat > result.tvmcg
            ? SSJ10095TakeoffPerformanceCalculator.wetTowAdjustmentFactorsAboveTvmcg
            : SSJ10095TakeoffPerformanceCalculator.wetTowAdjustmentFactorsAtOrBelowTvmcg
        )[result.inputs.conf].get(SSJ10095TakeoffPerformanceCalculator.vec4Cache, result.params.headwind);
        ...
        switch (runwayCondition) {
          case RunwayCondition.Contaminated6mmWater:
            correctionFactors = SSJ10095TakeoffPerformanceCalculator.weightCorrectionContaminated6mmWater;
            mtowFactors = SSJ10095TakeoffPerformanceCalculator.mtowContaminated6mmWater;
            minCorrectedWeight = SSJ10095TakeoffPerformanceCalculator.minCorrectedTowContaminated6mmWater;
            break;
          case RunwayCondition.Contaminated13mmWater:
            correctionFactors = SSJ10095TakeoffPerformanceCalculator.weightCorrectionContaminated13mmWater;
            mtowFactors = SSJ10095TakeoffPerformanceCalculator.mtowContaminated13mmWater;
            minCorrectedWeight = SSJ10095TakeoffPerformanceCalculator.minCorrectedTowContaminated13mmWater;
            break;
          case RunwayCondition.Contaminated6mmSlush:
            correctionFactors = SSJ10095TakeoffPerformanceCalculator.weightCorrectionContaminated6mmSlush;
            mtowFactors = SSJ10095TakeoffPerformanceCalculator.mtowContaminated6mmSlush;
            minCorrectedWeight = SSJ10095TakeoffPerformanceCalculator.minCorrectedTowContaminated6mmSlush;
            break;
          case RunwayCondition.Contaminated13mmSlush:
            correctionFactors = SSJ10095TakeoffPerformanceCalculator.weightCorrectionContaminated13mmSlush;
            mtowFactors = SSJ10095TakeoffPerformanceCalculator.mtowContaminated13mmSlush;
            minCorrectedWeight = SSJ10095TakeoffPerformanceCalculator.minCorrectedTowContaminated13mmSlush;
            break;
          case RunwayCondition.ContaminatedCompactedSnow:
            correctionFactors = SSJ10095TakeoffPerformanceCalculator.weightCorrectionContaminatedCompactedSnow;
            mtowFactors = SSJ10095TakeoffPerformanceCalculator.mtowContaminatedCompactedSnow;
            minCorrectedWeight = SSJ10095TakeoffPerformanceCalculator.minCorrectedTowContaminatedCompactedSnow;
            break;
          case RunwayCondition.Contaminated5mmWetSnow:
            correctionFactors = SSJ10095TakeoffPerformanceCalculator.weightCorrectionContaminated5mmWetSnow;
            mtowFactors = SSJ10095TakeoffPerformanceCalculator.mtowContaminated5mmWetSnow;
            minCorrectedWeight = SSJ10095TakeoffPerformanceCalculator.minCorrectedTowContaminated5mmWetSnow;
            break;
          case RunwayCondition.Contaminated15mmWetSnow:
            correctionFactors = SSJ10095TakeoffPerformanceCalculator.weightCorrectionContaminated15mmWetSnow;
            mtowFactors = SSJ10095TakeoffPerformanceCalculator.mtowContaminated15mmWetSnow;
            minCorrectedWeight = SSJ10095TakeoffPerformanceCalculator.minCorrectedTowContaminated15mmWetSnow;
            break;
          case RunwayCondition.Contaminated30mmWetSnow:
            correctionFactors = SSJ10095TakeoffPerformanceCalculator.weightCorrectionContaminated30mmWetSnow;
            mtowFactors = SSJ10095TakeoffPerformanceCalculator.mtowContaminated30mmWetSnow;
            minCorrectedWeight = SSJ10095TakeoffPerformanceCalculator.minCorrectedTowContaminated30mmWetSnow;
            break;
          case RunwayCondition.Contaminated10mmDrySnow:
            correctionFactors = SSJ10095TakeoffPerformanceCalculator.weightCorrectionContaminated10mmDrySnow;
            mtowFactors = SSJ10095TakeoffPerformanceCalculator.mtowContaminated10mmDrySnow;
            minCorrectedWeight = SSJ10095TakeoffPerformanceCalculator.minCorrectedTowContaminated10mmDrySnow;
            break;
          case RunwayCondition.Contaminated100mmDrySnow:
            correctionFactors = SSJ10095TakeoffPerformanceCalculator.weightCorrectionContaminated100mmDrySnow;
            mtowFactors = SSJ10095TakeoffPerformanceCalculator.mtowContaminated100mmDrySnow;
            minCorrectedWeight = SSJ10095TakeoffPerformanceCalculator.minCorrectedTowContaminated100mmDrySnow;
            break;
          default:
      ...
      if (applyForwardCgWeightCorrection) {
        const cgFactors = SSJ10095TakeoffPerformanceCalculator.cgFactors[conf];
      ...
      if (mtow >= tow) {
        ...
        if (forceToga) {
          ...
          const tailwindResult = this.calculateTakeoffPerformance(
            ...
            runwayCondition,
            cg,
            SSJ10095TakeoffPerformanceCalculator.resultCache,
          );
        ...
        if (result.inputs.runwayCondition === RunwayCondition.Wet) {
          ...
          const factors: ReadonlyFloat64Array = (
            result.inputs.oat > tvmcg
              ? SSJ10095TakeoffPerformanceCalculator.wetFlexAdjustmentFactorsAboveTvmcg
              : SSJ10095TakeoffPerformanceCalculator.wetFlexAdjustmentFactorsAtOrBelowTvmcg
          )[result.inputs.conf].get(SSJ10095TakeoffPerformanceCalculator.vec4Cache, result.params.headwind);
  ...
  private calculateVSpeeds(
    ...
    if (result.inputs.runwayCondition == RunwayCondition.Dry || result.inputs.runwayCondition === RunwayCondition.Wet) {
      ...
      if (result.inputs.runwayCondition === RunwayCondition.Dry) {
        ...
        const v1Factors: ReadonlyFloat64Array = (
          result.inputs.oat > tvmcg
            ? SSJ10095TakeoffPerformanceCalculator.wetV1AdjustmentFactorsAboveTvmcg
            : SSJ10095TakeoffPerformanceCalculator.wetV1AdjustmentFactorsAtOrBelowTvmcg
        )[result.inputs.conf].get(SSJ10095TakeoffPerformanceCalculator.vec4Cache, result.params.headwind);
        const vRFactors: ReadonlyFloat64Array | undefined = (
          result.inputs.oat > tvmcg
            ? undefined
            : SSJ10095TakeoffPerformanceCalculator.wetVRAdjustmentFactorsAtOrBelowTvmcg
        )?.[result.inputs.conf].get(SSJ10095TakeoffPerformanceCalculator.vec4Cache, result.params.headwind);
        const v2Factors: ReadonlyFloat64Array | undefined = (
          result.inputs.oat > tvmcg
            ? undefined
            : SSJ10095TakeoffPerformanceCalculator.wetV2AdjustmentFactorsAtOrBelowTvmcg
        )?.[result.inputs.conf].get(SSJ10095TakeoffPerformanceCalculator.vec4Cache, result.params.headwind);
    ...
    switch (result.inputs.runwayCondition) {
      case RunwayCondition.Contaminated6mmWater:
        contamVSpeeds = SSJ10095TakeoffPerformanceCalculator.vSpeedsContaminated6mmWater;
        break;
      case RunwayCondition.Contaminated13mmWater:
        contamVSpeeds = SSJ10095TakeoffPerformanceCalculator.vSpeedsContaminated13mmWater;
        break;
      case RunwayCondition.Contaminated6mmSlush:
        contamVSpeeds = SSJ10095TakeoffPerformanceCalculator.vSpeedsContaminated6mmSlush;
        break;
      case RunwayCondition.Contaminated13mmSlush:
        contamVSpeeds = SSJ10095TakeoffPerformanceCalculator.vSpeedsContaminated13mmSlush;
        break;
      case RunwayCondition.ContaminatedCompactedSnow:
        contamVSpeeds = SSJ10095TakeoffPerformanceCalculator.vSpeedsContaminatedCompactedSnow;
        break;
      case RunwayCondition.Contaminated5mmWetSnow:
        contamVSpeeds = SSJ10095TakeoffPerformanceCalculator.vSpeedsContaminated5mmWetSnow;
        break;
      case RunwayCondition.Contaminated15mmWetSnow:
        contamVSpeeds = SSJ10095TakeoffPerformanceCalculator.vSpeedsContaminated15mmWetSnow;
        break;
      case RunwayCondition.Contaminated10mmDrySnow:
        contamVSpeeds = SSJ10095TakeoffPerformanceCalculator.vSpeedsContaminated10mmDrySnow;
        break;
      case RunwayCondition.Contaminated100mmDrySnow:
        contamVSpeeds = SSJ10095TakeoffPerformanceCalculator.vSpeedsContaminated100mmDrySnow;
        break;
      default:
        throw new Error('Invalid runway condition');
    }
    ...
    const [v1, vR, v2] = contamVSpeeds[result.inputs.conf].get(
      SSJ10095TakeoffPerformanceCalculator.vec3Cache,
      result.inputs.tow,
    );
  ...
  private calculateDryVSpeeds(result: Partial<TakeoffPerformanceResult>, applyForwardCgSpeedCorrection: boolean): void {
    ...
    if (limitingFactor === LimitingFactor.Runway || limitingFactor === LimitingFactor.Vmcg) {
      ...
      const [v2BaseFactor1, v2BaseFactor2]: [number, number] =
        SSJ10095TakeoffPerformanceCalculator.v2RunwayVmcgBaseFactors[result.inputs.conf];
      speeds.v2Base = (result.inputs.tow / 1000) * v2BaseFactor1 + v2BaseFactor2;

      const [v2AltFactor1, v2AltFactor2] =
        SSJ10095TakeoffPerformanceCalculator.v2RunwayVmcgAltFactors[result.inputs.conf];
      ...
      const [vRBaseFactor1, vRBaseFactor2]: [number, number] =
        SSJ10095TakeoffPerformanceCalculator.vRRunwayVmcgBaseFactors[result.inputs.conf];
      speeds.vRBase = (result.inputs.tow / 1000) * vRBaseFactor1 + vRBaseFactor2;

      const [vRBaseLength, vRRunwayFactor1, vRRunwayFactor2] =
        SSJ10095TakeoffPerformanceCalculator.vRRunwayVmcgRunwayFactors[result.inputs.conf];
      ...
      const [vRFactorAlt1, vRFactorAlt2] =
        SSJ10095TakeoffPerformanceCalculator.vRRunwayVmcgAltFactors[result.inputs.conf];
      speeds.vRDeltaAlt = result.params.pressureAlt * ((result.inputs.tow / 1000) * vRFactorAlt1 + vRFactorAlt2);

      const vRFactorSlope = SSJ10095TakeoffPerformanceCalculator.vRRunwayVmcgSlopeFactors[result.inputs.conf];
      ...
      const [vRWindFactor1, vRWindFactor2] =
        result.params.headwind >= 0
          ? SSJ10095TakeoffPerformanceCalculator.vRRunwayVmcgHeadwindFactors[result.inputs.conf]
          : SSJ10095TakeoffPerformanceCalculator.vRRunwayVmcgTailwindFactors[result.inputs.conf];
      ...
      const [v1BaseFactor1, v1BaseFactor2]: [number, number] =
        SSJ10095TakeoffPerformanceCalculator.v1RunwayVmcgBaseFactors[result.inputs.conf];
      speeds.v1Base = (result.inputs.tow / 1000) * v1BaseFactor1 + v1BaseFactor2;

      const [v1BaseLength, v1RunwayFactor1, v1RunwayFactor2] =
        SSJ10095TakeoffPerformanceCalculator.v1RunwayVmcgRunwayFactors[result.inputs.conf];
      ...
      const [v1FactorAlt1, v1FactorAlt2] =
        SSJ10095TakeoffPerformanceCalculator.v1RunwayVmcgAltFactors[result.inputs.conf];
      speeds.v1DeltaAlt = result.params.pressureAlt * ((result.inputs.tow / 1000) * v1FactorAlt1 + v1FactorAlt2);

      const v1FactorSlope = SSJ10095TakeoffPerformanceCalculator.v1RunwayVmcgSlopeFactors[result.inputs.conf];
      speeds.v1DeltaSlope = result.inputs.slope * result.params.adjustedTora * v1FactorSlope;

      const [v1WindFactor1, v1WindFactor2] =
        result.params.headwind >= 0
          ? SSJ10095TakeoffPerformanceCalculator.v1RunwayVmcgHeadwindFactors[result.inputs.conf]
          : SSJ10095TakeoffPerformanceCalculator.v1RunwayVmcgTailwindFactors[result.inputs.conf];
      ...
      const [v2ThresholdFactor1, v2ThresholdFactor2] =
        SSJ10095TakeoffPerformanceCalculator.v2SecondSegBrakeThresholds[result.inputs.conf];
      ...
      const [vRBaseFactor1, vRBaseFactor2]: [number, number] = useTable2
        ? SSJ10095TakeoffPerformanceCalculator.vRSecondSegBrakeBaseTable2[result.inputs.conf]
        : SSJ10095TakeoffPerformanceCalculator.vRSecondSegBrakeBaseTable1[result.inputs.conf];
      speeds.vRBase = (result.inputs.tow / 1000) * vRBaseFactor1 + vRBaseFactor2;

      const [vRBaseLength, vRRunwayFactor1, vRRunwayFactor2] = useTable2
        ? SSJ10095TakeoffPerformanceCalculator.vRSecondSegBrakeRunwayTable2[result.inputs.conf]
        : SSJ10095TakeoffPerformanceCalculator.vRSecondSegBrakeRunwayTable1[result.inputs.conf];
      speeds.vRDeltaRunway =
        (vRBaseLength - result.params.adjustedTora) * ((result.inputs.tow / 1000) * vRRunwayFactor1 + vRRunwayFactor2);

      const [vRAltFactor1, vRAltFactor2, vRAltFactor3, vRAltFactor4] = useTable2
        ? SSJ10095TakeoffPerformanceCalculator.vRSecondSegBrakeAltTable2[result.inputs.conf]
        : SSJ10095TakeoffPerformanceCalculator.vRSecondSegBrakeAltTable1[result.inputs.conf];
      speeds.vRDeltaAlt =
        result.params.pressureAlt *
      ...
      const [vRSlopeFactor1, vRSlopeFactor2] =
        SSJ10095TakeoffPerformanceCalculator.vRSecondSegBrakeSlopeFactors[result.inputs.conf];
      speeds.vRDeltaSlope =
        result.inputs.slope *
        result.params.adjustedTora *
      ...
      const [vRWindFactor1, vRWindFactor2] =
        result.params.headwind >= 0
          ? SSJ10095TakeoffPerformanceCalculator.vRSecondSegBrakeHeadwindFactors[result.inputs.conf]
          : SSJ10095TakeoffPerformanceCalculator.vRSecondSegBrakeTailwindFactors[result.inputs.conf];
      speeds.vRDeltaWind = result.params.headwind * ((result.inputs.tow / 1000) * vRWindFactor1 + vRWindFactor2);
  ...
  private calculateSecondSegBrakeV2(
    ...
    const [v2BaseFactor1, v2BaseFactor2] =
      SSJ10095TakeoffPerformanceCalculator.v2SecondSegBrakeBaseTable1[result.inputs.conf];
    speeds.v2Base = (result.inputs.tow / 1000) * v2BaseFactor1 + v2BaseFactor2;

    if (useTable2) {
      const [v2BaseFactor1, v2BaseFactor2] =
        SSJ10095TakeoffPerformanceCalculator.v2SecondSegBrakeBaseTable2[result.inputs.conf];
      speeds.v2Base = (result.inputs.tow / 1000) * v2BaseFactor1 + v2BaseFactor2;
    }

    const [v2BaseRunwayLength, v2RunwayFactor] = useTable2
      ? SSJ10095TakeoffPerformanceCalculator.v2SecondSegBrakeRunwayTable2[result.inputs.conf]
      : SSJ10095TakeoffPerformanceCalculator.v2SecondSegBrakeRunwayTable1[result.inputs.conf];
    ...
    const [v2AltFactor1, v2AltFactor2, v2AltFactor3, v2AltFactor4] =
      SSJ10095TakeoffPerformanceCalculator.v2SecondSegBrakeAltFactors[result.inputs.conf];
    speeds.v2DeltaAlt =
      result.params.pressureAlt *
    ...
    const [v2SlopeFactor1, v2SlopeFactor2] =
      SSJ10095TakeoffPerformanceCalculator.v2SecondSegBrakeSlopeFactors[result.inputs.conf];
    speeds.v2DeltaSlope =
    ...
    if (correctWind) {
      const v2WindFactor =
        result.params.headwind >= 0
          ? SSJ10095TakeoffPerformanceCalculator.v2SecondSegBrakeHeadwindFactors[result.inputs.conf]
          : SSJ10095TakeoffPerformanceCalculator.v2SecondSegBrakeTailwindFactors[result.inputs.conf];
  ...
  private calculateSecondSegBrakeV1(
    ...
    const [v1BaseFactor1, v1BaseFactor2]: [number, number] = useTable2
      ? SSJ10095TakeoffPerformanceCalculator.v1SecondSegBrakeBaseTable2[result.inputs.conf]
      : SSJ10095TakeoffPerformanceCalculator.v1SecondSegBrakeBaseTable1[result.inputs.conf];
    speeds.v1Base = (result.inputs.tow / 1000) * v1BaseFactor1 + v1BaseFactor2;

    const [v1BaseLength, v1RunwayFactor1, v1RunwayFactor2] = useTable2
      ? SSJ10095TakeoffPerformanceCalculator.v1SecondSegBrakeRunwayTable2[result.inputs.conf]
      : SSJ10095TakeoffPerformanceCalculator.v1SecondSegBrakeRunwayTable1[result.inputs.conf];
    speeds.v1DeltaRunway =
      (v1BaseLength - result.params.adjustedTora) * ((result.inputs.tow / 1000) * v1RunwayFactor1 + v1RunwayFactor2);

    const [v1AltFactor1, v1AltFactor2, v1AltFactor3, v1AltFactor4] = useTable2
      ? SSJ10095TakeoffPerformanceCalculator.v1SecondSegBrakeAltTable2[result.inputs.conf]
      : SSJ10095TakeoffPerformanceCalculator.v1SecondSegBrakeAltTable1[result.inputs.conf];
    speeds.v1DeltaAlt =
      result.params.pressureAlt *
    ...
    const [v1SlopeFactor1, v1SlopeFactor2] =
      SSJ10095TakeoffPerformanceCalculator.v1SecondSegBrakeSlopeFactors[result.inputs.conf];
    speeds.v1DeltaSlope =
      result.inputs.slope * result.params.adjustedTora * ((result.inputs.tow / 1000) * v1SlopeFactor1 + v1SlopeFactor2);

    const [v1WindFactor1, v1WindFactor2] =
      result.params.headwind >= 0
        ? SSJ10095TakeoffPerformanceCalculator.v1SecondSegBrakeHeadwindFactors[result.inputs.conf]
        : SSJ10095TakeoffPerformanceCalculator.v1SecondSegBrakeTailwindFactors[result.inputs.conf];
    speeds.v1DeltaWind = result.params.headwind * ((result.inputs.tow / 1000) * v1WindFactor1 + v1WindFactor2);
  ...
  private reconcileVSpeeds(
    ...
    const minV1Vmc = Math.ceil(SSJ10095TakeoffPerformanceCalculator.minimumV1Vmc.get(result.params.pressureAlt));
    const minVrVmc = Math.ceil(SSJ10095TakeoffPerformanceCalculator.minimumVrVmc.get(result.params.pressureAlt));
    const minV2Vmc = Math.ceil(
      SSJ10095TakeoffPerformanceCalculator.minimumV2Vmc[result.inputs.conf].get(result.params.pressureAlt),
    );
    const minv2Vmu = Math.ceil(
      SSJ10095TakeoffPerformanceCalculator.minimumV2Vmu[result.inputs.conf].get(
        result.params.pressureAlt,
        result.inputs.tow,
      ),
    );
  ...
  private calculateWeightLimits(
    ...
    let baseFactors: typeof SSJ10095TakeoffPerformanceCalculator.secondSegmentBaseFactor | undefined;
    let slopeFactors: typeof SSJ10095TakeoffPerformanceCalculator.runwaySlopeFactor;
    let altFactors: typeof SSJ10095TakeoffPerformanceCalculator.runwayPressureAltFactor;
    ...
    switch (limitingFactor) {
      case LimitingFactor.Runway:
        // no base factors
        slopeFactors = SSJ10095TakeoffPerformanceCalculator.runwaySlopeFactor;
        altFactors = SSJ10095TakeoffPerformanceCalculator.runwayPressureAltFactor;
        tempDeltaFunc = this.calculateRunwayTempDelta;
        windDeltaFunc = this.calculateRunwayWindDelta;
        break;
      case LimitingFactor.SecondSegment:
        baseFactors = SSJ10095TakeoffPerformanceCalculator.secondSegmentBaseFactor;
        slopeFactors = SSJ10095TakeoffPerformanceCalculator.secondSegmentSlopeFactor;
        altFactors = SSJ10095TakeoffPerformanceCalculator.secondSegmentPressureAltFactor;
        tempDeltaFunc = this.calculateSecondSegmentTempDelta;
        windDeltaFunc = this.calculateSecondSegmentWindDelta;
        break;
      case LimitingFactor.BrakeEnergy:
        baseFactors = SSJ10095TakeoffPerformanceCalculator.brakeEnergyBaseFactor;
        slopeFactors = SSJ10095TakeoffPerformanceCalculator.brakeEnergySlopeFactor;
        altFactors = SSJ10095TakeoffPerformanceCalculator.brakeEnergyPressureAltFactor;
        tempDeltaFunc = this.calculateBrakeEnergyTempDelta;
        windDeltaFunc = this.calculateBrakeEnergyWindDelta;
        break;
      case LimitingFactor.Vmcg:
        baseFactors = SSJ10095TakeoffPerformanceCalculator.vmcgBaseFactor;
        slopeFactors = SSJ10095TakeoffPerformanceCalculator.vmcgSlopeFactor;
        altFactors = SSJ10095TakeoffPerformanceCalculator.vmcgPressureAltFactor;
  ...
  public calculateTakeoffPerformanceOptConf(
    ...
    const results = [1, 2, 3].map((conf, cacheIndex) =>
      this.calculateTakeoffPerformance(
        ...
        runwayCondition,
        cg,
        // SSJ10095TakeoffPerformanceCalculator.optResultCache[cacheIndex],
      ),
    );
    ...
    if (filteredResults.length === 0) {
      return SSJ10095TakeoffPerformanceCalculator.deepCopy(results[results.length - 1], out);
    }
    ...
    return SSJ10095TakeoffPerformanceCalculator.deepCopy(filteredResults[0], out ?? {});
  }
  ...
  private calculateTvmcg(inputs: TakeoffPerformanceInputs, params: TakeoffPerformanceParameters): number {
    const factors: LerpVectorLookupTable = SSJ10095TakeoffPerformanceCalculator.tvmcgFactors[inputs.conf];
    const [factor1, factor2] = factors.get(
      SSJ10095TakeoffPerformanceCalculator.vec2Cache,
  ...
  private calculateTref(elevation: number): number {
    return SSJ10095TakeoffPerformanceCalculator.tRefTable.get(elevation);
  }
  ...
  private calculateTmax(pressureAlt: number): number {
    return SSJ10095TakeoffPerformanceCalculator.tMaxTable.get(pressureAlt);
  }
  ...
  private calculateTflexMax(isa: number): number {
    return isa + SSJ10095TakeoffPerformanceCalculator.tMaxFlexDisa;
  }
  ...
  private calculateBaseRunwayPerfLimit(length: number, conf: number): number {
    switch (conf) {
      case 1:
        return SSJ10095TakeoffPerformanceCalculator.runwayPerfLimitConf1.get(length);
      case 2:
        return SSJ10095TakeoffPerformanceCalculator.runwayPerfLimitConf2.get(length);
      case 3:
        return SSJ10095TakeoffPerformanceCalculator.runwayPerfLimitConf3.get(length);
      default:
        return NaN;
    }
  }
  ...
  private calculateRunwayTempDelta(
    ...
    const tempFactors = SSJ10095TakeoffPerformanceCalculator.runwayTemperatureFactor[conf];
  ...
  private calculateSecondSegmentTempDelta(
    ...
    const tempFactors = SSJ10095TakeoffPerformanceCalculator.secondSegmentTemperatureFactor[conf];
  ...
  private calculateBrakeEnergyTempDelta(
    ...
    const tempFactors = SSJ10095TakeoffPerformanceCalculator.brakeEnergyTemperatureFactor[conf];
  ...
  private calculateVmcgTempDelta(
    ...
    const tempFactors = SSJ10095TakeoffPerformanceCalculator.vmcgTemperatureFactor[conf];
  ...
  private calculateRunwayWindDelta(
    ...
    const windFactors =
      wind >= 0
        ? SSJ10095TakeoffPerformanceCalculator.runwayHeadWindFactor[conf]
        : SSJ10095TakeoffPerformanceCalculator.runwayTailWindFactor[conf];
  ...
  private calculateSecondSegmentWindDelta(
    ...
    const windFactors =
      wind >= 0
        ? SSJ10095TakeoffPerformanceCalculator.secondSegmentHeadWindFactor[conf]
        : SSJ10095TakeoffPerformanceCalculator.secondSegmentTailWindFactor[conf];
  ...
  private calculateBrakeEnergyWindDelta(
    ...
    const windFactors =
      wind >= 0
        ? SSJ10095TakeoffPerformanceCalculator.brakeEnergyHeadWindFactor[conf]
        : SSJ10095TakeoffPerformanceCalculator.brakeEnergyTailWindFactor[conf];
  ...
  private calculateVmcgWindDelta(
    ...
    if (wind >= 0) {
      const windFactors = SSJ10095TakeoffPerformanceCalculator.vmcgHeadWindFactor[conf];
      ...
      const windFactors = SSJ10095TakeoffPerformanceCalculator.vmcgTailWindFactor[conf];
  ...
  public isCgWithinLimits(cg: number, tow: number): boolean {
    const cgLimits = SSJ10095TakeoffPerformanceCalculator.takeoffCgLimits.get(
      SSJ10095TakeoffPerformanceCalculator.vec2Cache,
      tow,
    );
