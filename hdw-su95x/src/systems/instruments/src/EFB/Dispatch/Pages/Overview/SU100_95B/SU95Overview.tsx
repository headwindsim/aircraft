...
import { SU95NoseOutline } from '../../../../Assets/NoseOutline';
...
export const SU95Overview = () => {
    ...
    return (
        <div className="h-content-section-reduced border-theme-accent mr-3 w-min overflow-hidden rounded-lg border-2 p-6">
            <h1 className="font-bold">Sukhoi Superjet 100-95B</h1>
            <p>{airline}</p>

            <div className="mt-6 flex items-center justify-center">
                <SU95NoseOutline className="text-theme-text flip-horizontal -ml-96 mr-32 h-64" />
            </div>
