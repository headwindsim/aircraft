...
class FacComputer final
{
 public:
  ...
  struct Parameters_FacComputer_T {
    ...
    real_T uDLookupTable1_tableData[35];
    real_T uDLookupTable1_bp01Data[7];
    real_T uDLookupTable1_bp02Data[5];
    real_T uDLookupTable2_tableData_l[84];
    real_T uDLookupTable2_bp01Data_j[28];
    real_T uDLookupTable2_bp02Data[3];
    real_T uDLookupTable3_tableData_n[576];
    real_T uDLookupTable3_bp01Data_e[18];
    real_T uDLookupTable3_bp02Data[32];
