...
{
  *rty_v_s = (rtu_m_lbs / 2205.0 - 22.0) * rtu_b + rtu_a;
}
...
void FacComputer::FacComputer_MATLABFunction_l(const base_arinc_429 *rtu_u, boolean_T *rty_y)
{
...
void FacComputer::step()
{
  ...
  real_T rtb_BusAssignment_g5_flight_envelope_v_3_kn;
  real_T rtb_BusAssignment_g5_flight_envelope_v_stall_kn;
  real_T rtb_BusAssignment_kv_flight_envelope_v_alpha_max_kn;
  real_T rtb_BusAssignment_kv_flight_envelope_v_stall_warn_kn;
  real_T rtb_Gain_a;
  real_T rtb_Gain_f;
  real_T rtb_Switch;
  real_T rtb_Switch1_a;
  real_T rtb_Switch4_f;
  real_T rtb_Switch4_j;
  real_T rtb_Switch_b;
  real_T rtb_Y_br;
  real_T rtb_Y_g4;
  real_T rtb_Y_l;
  ...
  int32_T rtb_v_alpha_lim_kn_SSM;
  ...
  boolean_T rtb_BusAssignment_m_logic_lgciu_own_valid;
  boolean_T rtb_DataTypeConversion_cl;
  boolean_T rtb_DataTypeConversion_jc;
  boolean_T rtb_DataTypeConversion_kr;
  boolean_T rtb_DataTypeConversion_l2;
  boolean_T rtb_DataTypeConversion_mg;
  ...
  if (FacComputer_U.in.sim_data.computer_running) {
    if (!FacComputer_DWork.Runtime_MODE) {
      ...
      FacComputer_MATLABFunction_i_Reset(&FacComputer_DWork.sf_MATLABFunction_p4);
    ...
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.fac_opp_bus.discrete_word_5,
      FacComputer_P.BitfromLabel1_bit, &rtb_y_p2);
    FacComputer_MATLABFunction(&FacComputer_U.in.bus_inputs.fac_opp_bus.discrete_word_5, &rtb_y_lg);
    rtb_AND1 = ((rtb_y_p2 != 0U) && rtb_y_lg);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.fac_opp_bus.discrete_word_5,
      FacComputer_P.BitfromLabel4_bit, &rtb_y_au);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.fac_opp_bus.discrete_word_5,
      FacComputer_P.BitfromLabel3_bit, &rtb_y_k);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.fac_opp_bus.discrete_word_5,
      FacComputer_P.BitfromLabel2_bit, &rtb_y_p2);
    FacComputer_MATLABFunction(&FacComputer_U.in.bus_inputs.lgciu_own_bus.discrete_word_1, &rtb_DataTypeConversion_kr);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.lgciu_own_bus.discrete_word_2,
      FacComputer_P.BitfromLabel_bit, &rtb_y_p);
    FacComputer_MATLABFunction_p((FacComputer_U.in.discrete_inputs.nose_gear_pressed == (rtb_y_p != 0U)),
      FacComputer_U.in.time.dt, FacComputer_P.ConfirmNode_isRisingEdge, FacComputer_P.ConfirmNode_timeDelay, &rtb_OR1,
      &FacComputer_DWork.sf_MATLABFunction_ax);
    rtb_Memory = (rtb_DataTypeConversion_kr && rtb_OR1);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.lgciu_own_bus.discrete_word_2,
    ...
    if (rtb_Memory) {
      rtb_y_lg = (rtb_y_p != 0U);
      rtb_Switch_i_idx_1 = (rtb_y_l2 != 0U);
      rtb_Switch_i_idx_2 = ((rtb_y_ph != 0U) || (rtb_y_ig != 0U));
    } else if (rtb_AND1) {
      rtb_y_lg = (rtb_y_au != 0U);
      rtb_Switch_i_idx_1 = (rtb_y_k != 0U);
      rtb_Switch_i_idx_2 = (rtb_y_p2 != 0U);
    } else {
      rtb_y_lg = FacComputer_P.Constant_Value_c;
    ...
    rtb_BusAssignment_kv_flight_envelope_v_alpha_max_kn = rtb_phi;
    rtb_Switch1_a = rtb_theta_dot;
    rtb_BusAssignment_m_logic_lgciu_own_valid = rtb_Memory;
    rtb_AND1 = ((!rtb_Memory) && (!rtb_AND1));
    rtb_DataTypeConversion_kr = (rtb_y_lg || rtb_Switch_i_idx_1);
    ...
    rtb_Memory = !rtb_DataTypeConversion_kr;
    FacComputer_MATLABFunction_p(rtb_Memory, FacComputer_U.in.time.dt, FacComputer_P.ConfirmNode_isRisingEdge_o,
      FacComputer_P.ConfirmNode_timeDelay_l, &rtb_OR1, &FacComputer_DWork.sf_MATLABFunction_p4);
    rtb_BusAssignment_h_logic_on_ground = rtb_DataTypeConversion_kr;
    rtb_BusAssignment_h_logic_speed_scale_visible = rtb_OR1;
    FacComputer_MATLABFunction(&FacComputer_U.in.bus_inputs.elac_1_bus.rudder_pedal_position_deg,
      &rtb_DataTypeConversion_kr);
    FacComputer_MATLABFunction(&FacComputer_U.in.bus_inputs.elac_2_bus.rudder_pedal_position_deg, &rtb_y_pm);
    Vtas = std::fmax(rtb_V_tas * 0.5144, 60.0);
    rtb_beDot = rtb_V_ias * 0.5144;
    if (rtb_V_ias >= 60.0F) {
      if (rtb_DataTypeConversion_kr) {
        rtb_Y_l = FacComputer_U.in.bus_inputs.elac_1_bus.rudder_pedal_position_deg.Data;
      } else if (rtb_y_pm) {
        rtb_Y_l = FacComputer_U.in.bus_inputs.elac_2_bus.rudder_pedal_position_deg.Data;
      } else {
        rtb_Y_l = FacComputer_P.Constant_Value_n;
      }

      rtb_beDot = (rtb_beDot * rtb_beDot * 0.6125 * 83.8 / (45000.0 * Vtas) * 3.172 * (FacComputer_P.Gain_Gain_h *
        rtb_Y_l) * 3.1415926535897931 / 180.0 + (rtb_phi * 3.1415926535897931 / 180.0 * (9.81 / Vtas) - rtb_r *
        3.1415926535897931 / 180.0)) * 180.0 / 3.1415926535897931;
    } else {
      rtb_beDot = 0.0;
    }

    FacComputer_LagFilter(rtb_beDot, FacComputer_P.LagFilter_C1, FacComputer_U.in.time.dt, &Vtas,
    ...
    FacComputer_LagFilter_k(FacComputer_U.in.bus_inputs.fmgc_own_bus.n1_right_percent.Data -
      ...
      FacComputer_U.in.time.dt, &rtb_y_mb, &FacComputer_DWork.sf_LagFilter_k);
    if (rtb_alpha > FacComputer_P.Saturation_UpperSat_a) {
      rtb_Y_l = FacComputer_P.Saturation_UpperSat_a;
    } else if (rtb_alpha < FacComputer_P.Saturation_LowerSat_l) {
      rtb_Y_l = FacComputer_P.Saturation_LowerSat_l;
    } else {
      rtb_Y_l = rtb_alpha;
    }

    FacComputer_LagFilter(rtb_Y_l, FacComputer_P.LagFilter2_C1, FacComputer_U.in.time.dt, &rtb_Switch1_a,
    ...
    FacComputer_LagFilter_k(FacComputer_U.in.bus_inputs.fmgc_own_bus.n1_left_percent.Data -
      ...
      FacComputer_U.in.time.dt, &rtb_y_a, &FacComputer_DWork.sf_LagFilter_d);
    if (rtb_V_ias > FacComputer_P.Saturation1_UpperSat_o) {
      rtb_Y_g4 = FacComputer_P.Saturation1_UpperSat_o;
    } else if (rtb_V_ias < FacComputer_P.Saturation1_LowerSat_n) {
      rtb_Y_g4 = FacComputer_P.Saturation1_LowerSat_n;
    } else {
      rtb_Y_g4 = rtb_V_ias;
    }

    rtb_beDot = (rtb_Switch1_a * rtb_y_a * FacComputer_P.Gain5_Gain + FacComputer_P.Gain4_Gain * rtb_y_mb) / rtb_Y_g4 /
      rtb_Y_g4 * FacComputer_P.Gain_Gain_k;
    FacComputer_LagFilter(static_cast<real_T>(rtb_alpha), FacComputer_P.LagFilter_C1_f, FacComputer_U.in.time.dt,
                          &rtb_Y_g4, &FacComputer_DWork.sf_LagFilter_c);
    rtb_BusAssignment_d_flight_envelope_alpha_filtered_deg = rtb_Y_g4;
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.elac_1_bus.discrete_status_word_2,
      FacComputer_P.BitfromLabel6_bit_m, &rtb_y_p2);
    rtb_OR1 = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.elac_2_bus.discrete_status_word_2,
      FacComputer_P.BitfromLabel7_bit_i, &rtb_y_p2);
    rtb_y_pm = (rtb_OR1 || (rtb_y_p2 != 0U));
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel_bit_i, &rtb_y_p2);
    rtb_DataTypeConversion_kr = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel1_bit_b, &rtb_y_p2);
    rtb_OR1 = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel2_bit_d, &rtb_y_p2);
    rtb_DataTypeConversion_mg = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel3_bit_n, &rtb_y_p2);
    rtb_DataTypeConversion_l2 = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel4_bit_c, &rtb_y_p2);
    rtb_DataTypeConversion_cl = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel5_bit_g, &rtb_y_p2);
    FacComputer_MATLABFunction_d(rtb_DataTypeConversion_kr, rtb_OR1, rtb_DataTypeConversion_mg,
      rtb_DataTypeConversion_l2, rtb_DataTypeConversion_cl, (rtb_y_p2 != 0U), &rtb_Switch4_f);
    ...
    rtb_Y_g4 = rtb_Gain_f - FacComputer_DWork.Delay_DSTATE;
    FacComputer_LagFilter(rtb_Y_g4 / FacComputer_U.in.time.dt, FacComputer_P.LagFilter_C1_k, FacComputer_U.in.time.dt,
                          &rtb_Y_g4, &FacComputer_DWork.sf_LagFilter);
    FacComputer_MATLABFunction(&FacComputer_U.in.bus_inputs.fmgc_own_bus.fg_radio_height_ft, &rtb_DataTypeConversion_kr);
    if (rtb_DataTypeConversion_kr) {
    ...
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.elac_1_bus.discrete_status_word_1,
      FacComputer_P.BitfromLabel9_bit, &rtb_y_p2);
    rtb_Memory = ((rtb_y_p2 != 0U) && rtb_DataTypeConversion_kr);
    ...
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.elac_2_bus.discrete_status_word_1,
      FacComputer_P.BitfromLabel8_bit_i, &rtb_y_p2);
    rtb_Memory = (rtb_Memory || ((rtb_y_p2 != 0U) && rtb_DataTypeConversion_kr));
    guard1 = false;
    if ((rtb_alpha_floor_inhib == 0) && (rtb_mach < 0.6)) {
      if (rtb_Switch4_f >= 4.0) {
        rtb_v_alpha_lim_kn_SSM = -3;
      } else {
        rtb_v_alpha_lim_kn_SSM = 0;
      }

      if ((rtb_BusAssignment_d_flight_envelope_alpha_filtered_deg > rtb_Switch1_a + std::fmin(std::fmax(rtb_Y_g4,
             static_cast<real_T>(rtb_v_alpha_lim_kn_SSM)), 0.0)) && rtb_Memory) {
    ...
    if (guard1) {
      if ((rtb_alpha_floor_inhib != 0) || (!rtb_y_pm) || (!rtb_Memory)) {
        FacComputer_DWork.sAlphaFloor = 0.0;
      }
    }

    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel_bit_a, &rtb_y_p2);
    rtb_Memory = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel1_bit_i, &rtb_y_p2);
    rtb_y_pm = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel2_bit_di, &rtb_y_p2);
    rtb_DataTypeConversion_kr = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel3_bit_g, &rtb_y_p2);
    rtb_OR1 = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel4_bit_f, &rtb_y_p2);
    rtb_DataTypeConversion_mg = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel5_bit_g3, &rtb_y_p2);
    FacComputer_MATLABFunction_d(rtb_Memory, rtb_y_pm, rtb_DataTypeConversion_kr, rtb_OR1, rtb_DataTypeConversion_mg,
      (rtb_y_p2 != 0U), &rtb_Switch4_f);
    ...
    FacComputer_RateLimiter(look2_binlxpw(static_cast<real_T>(rtb_mach), rtb_Switch4_f, FacComputer_P.alphamax_bp01Data,
      ...
      FacComputer_U.in.time.dt, FacComputer_P.reset_Value_o, &rtb_Y_g4, &FacComputer_DWork.sf_RateLimiter_a);
    FacComputer_CalculateV_alpha_max(static_cast<real_T>(rtb_V_ias),
      rtb_BusAssignment_d_flight_envelope_alpha_filtered_deg, rtb_Switch1_a, rtb_Y_g4,
      &rtb_BusAssignment_kv_flight_envelope_v_alpha_max_kn);
    FacComputer_RateLimiter(look2_binlxpw(static_cast<real_T>(rtb_mach), rtb_Switch4_f,
      ...
      FacComputer_U.in.time.dt, FacComputer_P.reset_Value_a, &rtb_Y_g4, &FacComputer_DWork.sf_RateLimiter_n);
    FacComputer_CalculateV_alpha_max(static_cast<real_T>(rtb_V_ias),
      rtb_BusAssignment_d_flight_envelope_alpha_filtered_deg, rtb_Switch1_a, rtb_Y_g4, &rtb_Switch);
    FacComputer_RateLimiter(look2_binlxpw(static_cast<real_T>(rtb_mach), rtb_Switch4_f,
    ...
    FacComputer_CalculateV_alpha_max(static_cast<real_T>(rtb_V_ias),
      rtb_BusAssignment_d_flight_envelope_alpha_filtered_deg, rtb_Switch1_a, rtb_Y_g4, &rtb_Switch4_f);
    FacComputer_MATLABFunction_l(&FacComputer_U.in.bus_inputs.fmgc_own_bus.fm_weight_lbs, &rtb_OR1);
    if (rtb_OR1) {
      rtb_DataTypeConversion2 = FacComputer_U.in.bus_inputs.fmgc_own_bus.fm_weight_lbs.Data;
      rtb_Y_g4 = FacComputer_U.in.bus_inputs.fmgc_own_bus.fm_weight_lbs.Data;
    } else {
      rtb_DataTypeConversion2 = FacComputer_U.in.bus_inputs.fmgc_own_bus.fac_weight_lbs.Data;
      rtb_Y_g4 = FacComputer_U.in.bus_inputs.fmgc_own_bus.fac_weight_lbs.Data;
    }

    rtb_BusAssignment_kv_flight_envelope_v_stall_warn_kn = rtb_Switch4_f;
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel_bit_k, &rtb_y_p2);
    rtb_Memory = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel1_bit_c, &rtb_y_p2);
    rtb_y_pm = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel2_bit_g, &rtb_y_p2);
    rtb_DataTypeConversion_kr = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel3_bit_d, &rtb_y_p2);
    rtb_OR1 = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel4_bit_a, &rtb_y_p2);
    rtb_DataTypeConversion_mg = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel5_bit_j, &rtb_y_p2);
    FacComputer_MATLABFunction_d(rtb_Memory, rtb_y_pm, rtb_DataTypeConversion_kr, rtb_OR1, rtb_DataTypeConversion_mg,
      (rtb_y_p2 != 0U), &rtb_Y_l);
    FacComputer_MATLABFunction2(look1_binlxpw(rtb_Y_l, FacComputer_P.uDLookupTable3_bp01Data,
      FacComputer_P.uDLookupTable3_tableData, 5U), look1_binlxpw(rtb_Y_l, FacComputer_P.uDLookupTable2_bp01Data,
      FacComputer_P.uDLookupTable2_tableData, 5U), static_cast<real_T>(rtb_DataTypeConversion2), &rtb_Y_g4);
    FacComputer_RateLimiter_f(rtb_Y_g4, FacComputer_P.RateLimiterGenericVariableTs1_up_d,
      FacComputer_P.RateLimiterGenericVariableTs1_lo_f, FacComputer_U.in.time.dt,
      FacComputer_P.RateLimiterGenericVariableTs1_InitialCondition, FacComputer_P.reset_Value_k5, &rtb_Y_br,
      &FacComputer_DWork.sf_RateLimiter_g0);
    FacComputer_MATLABFunction_l(&FacComputer_U.in.bus_inputs.elac_1_bus.speedbrake_extension_deg,
      &rtb_DataTypeConversion_kr);
    FacComputer_MATLABFunction_l(&FacComputer_U.in.bus_inputs.elac_2_bus.speedbrake_extension_deg, &rtb_OR1);
    if (rtb_DataTypeConversion_kr || rtb_OR1) {
      if (rtb_DataTypeConversion_kr) {
        rtb_Y_g4 = FacComputer_U.in.bus_inputs.elac_1_bus.speedbrake_extension_deg.Data;
      } else {
        rtb_Y_g4 = FacComputer_U.in.bus_inputs.elac_2_bus.speedbrake_extension_deg.Data;
      }
    } else {
      rtb_Y_g4 = FacComputer_P.Constant1_Value;
    }

    rtb_Switch4_f = rt_remd(static_cast<real_T>(rtb_phi), 360.0);
    rtb_Switch1_a = std::abs(rtb_Switch4_f);
    ...
    if (rtb_Switch1_a <= 45.0) {
      rtb_Switch4_f *= 0.017453292519943295;
      n = 0;
    } else if (rtb_Switch1_a <= 135.0) {
      if (rtb_Switch4_f > 0.0) {
        rtb_Switch4_f = (rtb_Switch4_f - 90.0) * 0.017453292519943295;
        n = 1;
      } else {
        rtb_Switch4_f = (rtb_Switch4_f + 90.0) * 0.017453292519943295;
        n = -1;
      }
    } else if (rtb_Switch4_f > 0.0) {
      rtb_Switch4_f = (rtb_Switch4_f - 180.0) * 0.017453292519943295;
      n = 2;
    } else {
      rtb_Switch4_f = (rtb_Switch4_f + 180.0) * 0.017453292519943295;
      n = -2;
    ...
    switch (n) {
     case 0:
      rtb_Switch4_f = std::cos(rtb_Switch4_f);
      break;

     case 1:
      rtb_Switch4_f = -std::sin(rtb_Switch4_f);
      break;
    ...
    rtb_Switch4_f = look2_binlxpw(look2_binlxpw(u0, static_cast<real_T>(rtb_DataTypeConversion2),
      FacComputer_P.uDLookupTable1_bp01Data, FacComputer_P.uDLookupTable1_bp02Data,
      FacComputer_P.uDLookupTable1_tableData, FacComputer_P.uDLookupTable1_maxIndex, 7U), static_cast<real_T>
      (FacComputer_U.in.bus_inputs.fmgc_own_bus.fm_cg_percent.Data), FacComputer_P.uDLookupTable2_bp01Data_j,
      FacComputer_P.uDLookupTable2_bp02Data, FacComputer_P.uDLookupTable2_tableData_l,
      FacComputer_P.uDLookupTable2_maxIndex, 28U);
    ...
    rtb_Switch1_a = look2_binlxpw(u0, rtb_Switch4_f, FacComputer_P.uDLookupTable3_bp01Data_e,
      FacComputer_P.uDLookupTable3_bp02Data, FacComputer_P.uDLookupTable3_tableData_n,
      FacComputer_P.uDLookupTable3_maxIndex, 18U);
    if (rtb_Switch1_a > FacComputer_P.Saturation1_UpperSat_ok) {
      rtb_Switch1_a = FacComputer_P.Saturation1_UpperSat_ok;
    } else if (rtb_Switch1_a < FacComputer_P.Saturation1_LowerSat_o) {
      rtb_Switch1_a = FacComputer_P.Saturation1_LowerSat_o;
    }

    if ((!rtb_AND1) && rtb_y_lg && rtb_Switch_i_idx_1) {
      FacComputer_DWork.takeoff_config = rtb_Y_l;
    } else if (FacComputer_DWork.takeoff_config != rtb_Y_l) {
    ...
    FacComputer_RateLimiter_f(rtb_Y_l, FacComputer_P.RateLimiterGenericVariableTs_up,
    ...
    if (rtb_alt >= FacComputer_P.CompareToConstant_const) {
      rtb_Y_l = std::sqrt(std::pow((std::pow(rtb_Switch1_a * rtb_Switch1_a * 0.2 + 1.0, 3.5) - 1.0) * (rtb_p_s_c /
        1013.25) + 1.0, 0.2857142857142857) - 1.0) * 1479.1;
    } else {
      rtb_Y_l = FacComputer_P.Constant_Value_l;
    }

    rtb_Switch1_a = std::fmax(std::fmax(rtb_Y_l, FacComputer_P.Vmcl_Value), rtb_Switch4_f);
    ...
    rtb_Y_g4 = FacComputer_P.Vmcl_Value_a + FacComputer_P.Bias2_Bias;
    ...
    rtb_Switch4_f = std::fmax(FacComputer_P.Gain_Gain_o * rtb_Switch4_f, rtb_Y_g4);
    rtb_v_gd = std::fmin(rtb_DataTypeConversion2 / 2205.0 * 1.25 + 169.0, 215.0) + std::fmax(rtb_alt - 20000.0, 0.0) /
      1000.0;
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel_bit_b, &rtb_y_p2);
    rtb_Memory = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel1_bit_ca, &rtb_y_p2);
    rtb_y_pm = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel2_bit_b, &rtb_y_p2);
    rtb_DataTypeConversion_kr = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel3_bit_l, &rtb_y_p2);
    rtb_OR1 = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel4_bit_l, &rtb_y_p2);
    rtb_DataTypeConversion_mg = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel5_bit_j4, &rtb_y_p2);
    FacComputer_MATLABFunction_d(rtb_Memory, rtb_y_pm, rtb_DataTypeConversion_kr, rtb_OR1, rtb_DataTypeConversion_mg,
      (rtb_y_p2 != 0U), &rtb_Y_g4);
    rtb_y_pm = ((rtb_Y_g4 == FacComputer_P.CompareToConstant3_const) || (rtb_Y_g4 ==
      FacComputer_P.CompareToConstant1_const));
    rtb_Memory = (rtb_Y_g4 == FacComputer_P.CompareToConstant_const_k);
    rtb_BusAssignment_g5_flight_envelope_v_stall_kn = rtb_Y_br;
    rtb_DataTypeConversion_kr = ((rtb_Y_g4 == FacComputer_P.CompareToConstant4_const) || (rtb_Y_g4 ==
      FacComputer_P.CompareToConstant2_const));
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel_bit_g, &rtb_y_p2);
    rtb_OR1 = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel1_bit_j, &rtb_y_p2);
    rtb_DataTypeConversion_mg = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel2_bit_n, &rtb_y_p2);
    rtb_DataTypeConversion_l2 = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel3_bit_h, &rtb_y_p2);
    rtb_DataTypeConversion_cl = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel4_bit_l5, &rtb_y_p2);
    rtb_DataTypeConversion_jc = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
      FacComputer_P.BitfromLabel5_bit_c, &rtb_y_p2);
    FacComputer_MATLABFunction_d(rtb_OR1, rtb_DataTypeConversion_mg, rtb_DataTypeConversion_l2,
      rtb_DataTypeConversion_cl, rtb_DataTypeConversion_jc, (rtb_y_p2 != 0U), &rtb_Switch1_a);
    ...
    rtb_DataTypeConversion_mg = ((rtb_Switch1_a < FacComputer_P.CompareToConstant_const_i) && (rtb_alt <=
      FacComputer_P.CompareToConstant1_const_i));
    if (rtb_Switch_i_idx_2) {
      rtb_Y_l = FacComputer_P.Constant2_Value;
    } else {
      rtb_Y_l = FacComputer_P.Constant3_Value;
    }

    rtb_Switch4_j = std::fmin(std::fmin(rtb_Y_l, std::sqrt(std::pow((std::pow(FacComputer_P.Constant1_Value_p *
      FacComputer_P.Constant1_Value_p * 0.2 + 1.0, 3.5) - 1.0) * (rtb_p_s_c / 1013.25) + 1.0, 0.2857142857142857) - 1.0)
      * 1479.1), look1_binlxpw(rtb_Switch1_a, FacComputer_P.uDLookupTable_bp01Data_a,
      FacComputer_P.uDLookupTable_tableData_a, 5U));
    if (rtb_V_ias > FacComputer_P.Saturation_UpperSat_j) {
      rtb_Y_l = FacComputer_P.Saturation_UpperSat_j;
    } else if (rtb_V_ias < FacComputer_P.Saturation_LowerSat_c) {
      rtb_Y_l = FacComputer_P.Saturation_LowerSat_c;
    } else {
      rtb_Y_l = rtb_V_ias;
    }

    rtb_Gain_a = FacComputer_P.DiscreteDerivativeVariableTs_Gain_l * rtb_Y_l;
    rtb_Switch1_a = rtb_Gain_a - FacComputer_DWork.Delay_DSTATE_d;
    FacComputer_LagFilter(rtb_Switch1_a / FacComputer_U.in.time.dt, FacComputer_P.LagFilter_C1_fa,
                          FacComputer_U.in.time.dt, &rtb_Y_br, &FacComputer_DWork.sf_LagFilter_i);
    FacComputer_RateLimiter_f(rtb_Y_br, FacComputer_P.RateLimiterGenericVariableTs_up_g,
      ...
      FacComputer_P.RateLimiterGenericVariableTs_InitialCondition_o, FacComputer_P.reset_Value_i3, &rtb_Switch1_a,
      &FacComputer_DWork.sf_RateLimiter_f);
    rtb_Switch1_a *= FacComputer_P.Gain_Gain_j;
    rtb_OR1 = (FacComputer_U.in.discrete_inputs.ap_own_engaged || FacComputer_U.in.discrete_inputs.ap_opp_engaged);
    rtb_DataTypeConversion_l2 = (FacComputer_U.in.discrete_inputs.rudder_trim_reset_button && (!rtb_OR1));
    ...
    if (FacComputer_P.PulseNode_isRisingEdge) {
      rtb_DataTypeConversion_cl = (rtb_DataTypeConversion_l2 && (!FacComputer_DWork.previousInput));
    } else {
      rtb_DataTypeConversion_cl = ((!rtb_DataTypeConversion_l2) && FacComputer_DWork.previousInput);
    }

    FacComputer_DWork.previousInput = rtb_DataTypeConversion_l2;
    FacComputer_DWork.Memory_PreviousInput = FacComputer_P.Logic_table
      [(((FacComputer_U.in.discrete_inputs.rudder_trim_switch_left ||
          FacComputer_U.in.discrete_inputs.rudder_trim_switch_right || rtb_OR1) + (static_cast<uint32_T>
          (rtb_DataTypeConversion_cl) << 1)) << 1) + FacComputer_DWork.Memory_PreviousInput];
    rtb_DataTypeConversion_l2 = !rtb_rudderTrimEngaged;
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.elac_1_bus.discrete_status_word_1,
      FacComputer_P.BitfromLabel_bit_j, &rtb_y_p2);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.elac_2_bus.discrete_status_word_1,
      FacComputer_P.BitfromLabel1_bit_e, &rtb_y_au);
    if (rtb_OR1) {
      if (FacComputer_U.in.bus_inputs.fmgc_own_bus.fg_radio_height_ft.Data >= FacComputer_P.Switch6_Threshold_n) {
        if ((rtb_y_p2 != 0U) && FacComputer_U.in.discrete_inputs.elac_1_healthy) {
          rtb_Y_l = FacComputer_U.in.bus_inputs.elac_1_bus.yaw_damper_command_deg.Data;
        } else if ((rtb_y_au != 0U) && FacComputer_U.in.discrete_inputs.elac_2_healthy) {
          rtb_Y_l = FacComputer_U.in.bus_inputs.elac_2_bus.yaw_damper_command_deg.Data;
        } else {
          rtb_Y_l = FacComputer_P.Constant1_Value_m;
        }

        rtb_Y_g4 = FacComputer_P.Gain2_Gain * rtb_Y_l;
      } else {
        rtb_Y_g4 = FacComputer_P.Constant2_Value_m;
      }

      if (rtb_Y_g4 > FacComputer_P.Saturation_UpperSat) {
        rtb_Y_g4 = FacComputer_P.Saturation_UpperSat;
      } else if (rtb_Y_g4 < FacComputer_P.Saturation_LowerSat) {
    ...
    rtb_Y_g4 = FacComputer_P.DiscreteTimeIntegratorVariableTs_Gain * rtb_Y_g4 * FacComputer_U.in.time.dt;
    FacComputer_DWork.icLoad = (FacComputer_DWork.Memory_PreviousInput || rtb_DataTypeConversion_l2 ||
      FacComputer_DWork.icLoad);
    if (FacComputer_DWork.icLoad) {
      if (rtb_DataTypeConversion_l2) {
        rtb_Y_l = FacComputer_U.in.analog_inputs.rudder_trim_position_deg;
      } else {
        rtb_Y_l = FacComputer_P.Constant_Value_g;
      }

      FacComputer_DWork.Delay_DSTATE_dc = rtb_Y_l - rtb_Y_g4;
    }

    FacComputer_DWork.Delay_DSTATE_dc += rtb_Y_g4;
    ...
    FacComputer_RateLimiter_p(FacComputer_DWork.Delay_DSTATE_dc, FacComputer_P.RateLimiterGenericVariableTs_up_l,
      ...
      FacComputer_U.in.analog_inputs.rudder_trim_position_deg, rtb_DataTypeConversion_l2, &rtb_Y_l,
      &FacComputer_DWork.sf_RateLimiter_l);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.elac_1_bus.discrete_status_word_1,
      FacComputer_P.BitfromLabel_bit_c, &rtb_y_p2);
    rtb_OR1 = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.elac_1_bus.discrete_status_word_1,
      FacComputer_P.BitfromLabel1_bit_n, &rtb_y_p2);
    rtb_DataTypeConversion_l2 = (rtb_OR1 && FacComputer_U.in.discrete_inputs.elac_1_healthy && (rtb_y_p2 != 0U));
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.elac_2_bus.discrete_status_word_1,
      FacComputer_P.BitfromLabel3_bit_k, &rtb_y_p2);
    rtb_OR1 = (rtb_y_p2 != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.elac_2_bus.discrete_status_word_1,
      FacComputer_P.BitfromLabel4_bit_k, &rtb_y_p2);
    ...
    rtb_Y_g4 = FacComputer_U.in.time.dt * FacComputer_P.WashoutFilter_C1;
    rtb_Y_br = 2.0 / (rtb_Y_g4 + 2.0);
    FacComputer_DWork.pY = (2.0 - rtb_Y_g4) / (rtb_Y_g4 + 2.0) * FacComputer_DWork.pY + (rtb_r * rtb_Y_br -
      FacComputer_DWork.pU * rtb_Y_br);
    FacComputer_DWork.pU = rtb_r;
    if (rtb_DataTypeConversion_l2 || (rtb_OR1 && FacComputer_U.in.discrete_inputs.elac_2_healthy && (rtb_y_p2 != 0U))) {
      if (rtb_DataTypeConversion_l2) {
        rtb_Y_g4 = FacComputer_U.in.bus_inputs.elac_1_bus.yaw_damper_command_deg.Data;
      } else {
      ...
      if (rtb_Y_g4 > FacComputer_P.Saturation1_UpperSat) {
        ...
        rtb_Y_g4 = FacComputer_P.Saturation1_LowerSat;
      }
    }

    if (rtb_Y_g4 > FacComputer_P.Saturation_UpperSat_e) {
      rtb_Y_g4 = FacComputer_P.Saturation_UpperSat_e;
    } else if (rtb_Y_g4 < FacComputer_P.Saturation_LowerSat_o) {
      rtb_Y_g4 = FacComputer_P.Saturation_LowerSat_o;
    }

    FacComputer_RateLimiter_p(rtb_Y_g4, FacComputer_P.RateLimiterGenericVariableTs_up_a,
    ...
    u0 = look1_binlxpw(static_cast<real_T>(rtb_V_ias), FacComputer_P.uDLookupTable_bp01Data_i,
                       FacComputer_P.uDLookupTable_tableData_j, 6U);
    if (u0 > FacComputer_P.Saturation_UpperSat_g) {
      u0 = FacComputer_P.Saturation_UpperSat_g;
    } else if (u0 < FacComputer_P.Saturation_LowerSat_f) {
      u0 = FacComputer_P.Saturation_LowerSat_f;
    }

    FacComputer_RateLimiter_p(u0, FacComputer_P.RateLimiterGenericVariableTs_up_c,
    ...
    FacComputer_MATLABFunction_g(rtb_VectorConcatenate, &rtb_y_a);
    if (FacComputer_P.Constant_Value_b5) {
      rtb_v_alpha_lim_kn_SSM = static_cast<int32_T>(FacComputer_P.EnumeratedConstant2_Value);
      ...
      if (rtb_BusAssignment_h_logic_speed_scale_visible) {
        rtb_v_alpha_lim_kn_SSM = static_cast<int32_T>(FacComputer_P.EnumeratedConstant1_Value);
        rtb_v_ls_kn_SSM = static_cast<int32_T>(FacComputer_P.EnumeratedConstant1_Value);
      } else {
        rtb_v_alpha_lim_kn_SSM = static_cast<int32_T>(FacComputer_P.EnumeratedConstant_Value);
      ...
      if (rtb_BusAssignment_h_logic_speed_scale_visible && rtb_DataTypeConversion_kr) {
      ...
      if (rtb_BusAssignment_h_logic_speed_scale_visible && rtb_y_pm) {
      ...
      if (rtb_BusAssignment_h_logic_speed_scale_visible && rtb_Memory) {
      ...
      if (rtb_BusAssignment_h_logic_speed_scale_visible && rtb_DataTypeConversion_mg) {
    ...
    FacComputer_MATLABFunction_g(rtb_VectorConcatenate, &rtb_y_mb);
    ...
    rtb_VectorConcatenate[5] = rtb_BusAssignment_m_logic_lgciu_own_valid;
    rtb_VectorConcatenate[6] = rtb_AND1;
    rtb_VectorConcatenate[7] = rtb_y_lg;
    ...
    FacComputer_Y.out.logic.lgciu_own_valid = rtb_BusAssignment_m_logic_lgciu_own_valid;
    FacComputer_Y.out.logic.all_lgciu_lost = rtb_AND1;
    FacComputer_Y.out.logic.left_main_gear_pressed = rtb_y_lg;
    ...
    FacComputer_Y.out.flight_envelope.estimated_beta_deg = Vtas;
    ...
    FacComputer_Y.out.flight_envelope.v_alpha_max_kn = rtb_BusAssignment_kv_flight_envelope_v_alpha_max_kn;
    FacComputer_Y.out.flight_envelope.v_alpha_prot_kn = rtb_Switch;
    FacComputer_Y.out.flight_envelope.v_stall_warn_kn = rtb_BusAssignment_kv_flight_envelope_v_stall_warn_kn;
    FacComputer_Y.out.flight_envelope.v_ls_kn = rtb_Switch_b;
    FacComputer_Y.out.flight_envelope.v_stall_kn = rtb_BusAssignment_g5_flight_envelope_v_stall_kn;
    FacComputer_Y.out.flight_envelope.v_3_kn = rtb_BusAssignment_g5_flight_envelope_v_3_kn;
    FacComputer_Y.out.flight_envelope.v_3_visible = rtb_DataTypeConversion_kr;
    FacComputer_Y.out.flight_envelope.v_4_kn = rtb_Switch4_f;
    FacComputer_Y.out.flight_envelope.v_4_visible = rtb_y_pm;
    FacComputer_Y.out.flight_envelope.v_man_kn = rtb_v_gd;
    FacComputer_Y.out.flight_envelope.v_man_visible = rtb_Memory;
    FacComputer_Y.out.flight_envelope.v_max_kn = rtb_Switch4_j;
    FacComputer_Y.out.flight_envelope.v_fe_next_kn = rtb_BusAssignment_f_flight_envelope_v_fe_next_kn;
    FacComputer_Y.out.flight_envelope.v_fe_next_visible = rtb_DataTypeConversion_mg;
    ...
    FacComputer_Y.out.bus_outputs.fac_slat_angle_deg.Data = FacComputer_P.Constant2_Value_b;
    ...
    FacComputer_Y.out.bus_outputs.estimated_sideslip_deg.Data = static_cast<real32_T>(Vtas);
    FacComputer_Y.out.bus_outputs.v_alpha_lim_kn.SSM = static_cast<uint32_T>(rtb_v_alpha_lim_kn_SSM);
    ...
    FacComputer_Y.out.bus_outputs.v_ls_kn.Data = static_cast<real32_T>(rtb_Switch_b);
    FacComputer_Y.out.bus_outputs.v_stall_kn.SSM = static_cast<uint32_T>(rtb_v_stall_kn_SSM);
    FacComputer_Y.out.bus_outputs.v_stall_kn.Data = static_cast<real32_T>
    ...
    FacComputer_Y.out.bus_outputs.v_alpha_prot_kn.Data = static_cast<real32_T>(rtb_Switch);
    ...
    FacComputer_Y.out.bus_outputs.v_stall_warn_kn.Data = static_cast<real32_T>
      (rtb_BusAssignment_kv_flight_envelope_v_stall_warn_kn);
    FacComputer_Y.out.bus_outputs.speed_trend_kn.SSM = static_cast<uint32_T>(rtb_speed_trend_kn_SSM);
    FacComputer_Y.out.bus_outputs.speed_trend_kn.Data = static_cast<real32_T>(rtb_Switch1_a);
    FacComputer_Y.out.bus_outputs.v_3_kn.SSM = static_cast<uint32_T>(rtb_v_3_kn_SSM);
    FacComputer_Y.out.bus_outputs.v_3_kn.Data = static_cast<real32_T>(rtb_BusAssignment_g5_flight_envelope_v_3_kn);
    FacComputer_Y.out.bus_outputs.v_4_kn.SSM = static_cast<uint32_T>(rtb_v_4_kn_SSM);
    FacComputer_Y.out.bus_outputs.v_4_kn.Data = static_cast<real32_T>(rtb_Switch4_f);
    FacComputer_Y.out.bus_outputs.v_man_kn.SSM = static_cast<uint32_T>(rtb_v_man_kn_SSM);
    FacComputer_Y.out.bus_outputs.v_man_kn.Data = static_cast<real32_T>(rtb_v_gd);
    FacComputer_Y.out.bus_outputs.v_max_kn.Data = static_cast<real32_T>(rtb_Switch4_j);
    FacComputer_Y.out.bus_outputs.v_fe_next_kn.SSM = static_cast<uint32_T>(rtb_alpha_floor_inhib);
    ...
    FacComputer_Y.out.bus_outputs.discrete_word_3.Data = rtb_y_mb;
    ...
    FacComputer_DWork.Delay_DSTATE_d = rtb_Gain_a;
