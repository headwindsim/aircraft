...
impl A320Payload {
    ...
    const A320_PAX: [PaxInfo<'static>; 5] = [
        PaxInfo {
            max_pax: 18,
            position: (20.8, 0., 0.4),
            pax_id: "PAX_A",
    ...
    pub fn new(context: &mut InitContext) -> Self {
        ...
        let default_boarding_agent = BoardingAgent::new(None, [0, 1, 2, 3, 4]);
        ...
        let boarding_agents = [
            ...
            BoardingAgent::new(
                Some(context.get_identifier("INTERACTIVE POINT OPEN:3".to_owned())),
                [4, 3, 2, 1, 0],
            ),
        ];
