...
impl SlatFlapControlComputer {
    ...
    fn demanded_slats_fppu_angle_from_conf(flap_conf: FlapsConf) -> Angle {
        match flap_conf {
            FlapsConf::Conf0 => Angle::new::<degree>(0.),
            FlapsConf::Conf1 => Angle::new::<degree>(250.62),
            FlapsConf::Conf1F => Angle::new::<degree>(250.62),
            FlapsConf::Conf2 => Angle::new::<degree>(334.16),
            FlapsConf::Conf3 => Angle::new::<degree>(334.16),
    ...
    fn slat_flap_actual_position_word(&self) -> Arinc429Word<u32> {
        ...
        word.set_bit(
            13,
            self.slats_feedback_angle > Angle::new::<degree>(240.4)
                && self.slats_feedback_angle < Angle::new::<degree>(337.),
        );
        word.set_bit(
            14,
            self.slats_feedback_angle > Angle::new::<degree>(327.3)
                && self.slats_feedback_angle < Angle::new::<degree>(337.),
        );
        word.set_bit(
            15,
