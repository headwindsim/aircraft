...
export default new TaskOfTasks('a32nx', [
    new TaskOfTasks('build', [
        new TaskOfTasks('instruments', [...getInstrumentsIgniterTasks(), new ExecTask('pfd','npm run build:pfd', ['src/instruments/src/PFD','headwind-aircraft-a330-900/html_ui/Pages/VCockpit/Instruments/A32NX/PFD'])], true),
        new ExecTask('atsu','npm run build:atsu', ['src/atsu', 'headwind-aircraft-a330-900/html_ui/JS/atsu']),
        new ExecTask('sentry-client','npm run build:sentry-client', ['src/sentry-client', 'headwind-aircraft-a330-900/html_ui/JS/sentry-client']),
        ...
        new ExecTask('fmgc','npm run build:fmgc', ['src/fmgc', 'headwind-aircraft-a330-900/html_ui/JS/fmgc']),
