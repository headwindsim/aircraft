...
import { A339XKeyInterceptor } from './modules/key_interceptor/KeyInterceptor';
...
import { A339XEcpBusPublisher } from '../shared/src/publishers/A339XEcpBusPublisher';
...
class ExtrasHost extends BaseInstrument {
  ...
  private readonly keyInterceptor: A339XKeyInterceptor;
  ...
  /**interactionpoint 5 is GPU connection and 1 GPU in total */
  private readonly gpuManagement = new GPUManagement(this.bus, 5, 1);
  ...
  constructor() {
    ...
    this.keyInterceptor = new A339XKeyInterceptor(this.bus, this.notificationManager);
    ...
    console.log('A339X_EXTRASHOST: Created');
  }

  get templateID(): string {
    return 'A339X_EXTRASHOST';
  }
