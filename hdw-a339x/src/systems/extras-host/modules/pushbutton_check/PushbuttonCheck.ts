...
import { A339XEcpBusEvents } from '../../../shared/src/publishers/A339XEcpBusPublisher';
...
export class PushbuttonCheck {
  ...
  private readonly sub = this.bus.getSubscriber<A339XEcpBusEvents & ExtrasSimVarEvents>();
