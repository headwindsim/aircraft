...
export class FakeDmc implements Instrument {
  ...
  public init(): void {
    ...
    this.buttonMapperFactory(SdPages.Press, 13, this.ecpSystemButtons);
    this.buttonMapperFactory(SdPages.ElecAC, 14, this.ecpSystemButtons);
    this.buttonMapperFactory(SdPages.ElecDC, 15, this.ecpSystemButtons);
    this.buttonMapperFactory(SdPages.Hyd, 16, this.ecpSystemButtons);
    this.buttonMapperFactory(SdPages.CB, 17, this.ecpSystemButtons);

    this.buttonMapperFactory(SdPages.Apu, 18, this.ecpSystemButtons);
    this.buttonMapperFactory(SdPages.Cond, 19, this.ecpSystemButtons);
    this.buttonMapperFactory(SdPages.Door, 20, this.ecpSystemButtons);
    this.buttonMapperFactory(SdPages.Wheel, 21, this.ecpSystemButtons);
    this.buttonMapperFactory(SdPages.Fctl, 22, this.ecpSystemButtons);
    this.buttonMapperFactory(SdPages.Fuel, 23, this.ecpSystemButtons);
  ...
  public onUpdate(): void {
    ...
    this.outputWord.setBitValue(15, this.sdPage === SdPages.ElecAC);
    this.outputWord.setBitValue(16, this.sdPage === SdPages.ElecDC);
    this.outputWord.setBitValue(17, this.sdPage === SdPages.Hyd);
    this.outputWord.setBitValue(18, this.sdPage === SdPages.CB);
    this.outputWord.setBitValue(19, this.sdPage === SdPages.Apu);
    this.outputWord.setBitValue(20, this.sdPage === SdPages.Cond);
    this.outputWord.setBitValue(21, this.sdPage === SdPages.Door);
    this.outputWord.setBitValue(22, this.sdPage === SdPages.Wheel);
    this.outputWord.setBitValue(23, this.sdPage === SdPages.Fctl);
    this.outputWord.setBitValue(24, this.sdPage === SdPages.Fuel);
