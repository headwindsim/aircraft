...
export class Ecp implements Instrument {
  ...
  private readonly warningKeys: Map<string, EcpKey | LitEcpKey> = new Map([
    ...
    [
      ...
      new LitEcpKey(
        ...
        (v) => this.lightStatusOutputWord.setBitValue(26, v),
      ),
    ],
    ...
    [
      ...
      new LitEcpKey(
        ...
        this.dimInput,
        this.clrLightRequested,
        (v) => this.lightStatusOutputWord.setBitValue(25, v),
      ),
    ],
    [
      'EMER_CANCEL',
  ...
  private readonly systemKeys: Map<string, EcpKey | LitEcpKey> = new Map([
    ...
    [
      ...
      new LitEcpKey(
        'HYD',
        (v) => this.systemSwitchesOutputWord.setBitValue(16, v),
        this.isOperatingNormally,
        this.lightTestInput,
        this.dimInput,
    ...
    [
      ...
      new LitEcpKey(
        ...
        this.lightTestInput,
        this.dimInput,
        this.dmcPageLightRequestFactory(23),
    ...
    [
      ...
      new LitEcpKey(
        'FUEL',
        (v) => this.systemSwitchesOutputWord.setBitValue(23, v),
        this.isOperatingNormally,
        this.lightTestInput,
        this.dimInput,
        this.dmcPageLightRequestFactory(24),
        (v) => this.lightStatusOutputWord.setBitValue(23, v),
        this.flashOn,
      ),
    ],
    ['ALL', new EcpKey('ALL', (v) => this.systemSwitchesOutputWord.setBitValue(24, v), this.isOperatingNormally)],
  ]);
  ...
  private readonly subs: Subscription[] = [
    ...
    this.dimInput.sub(
      (v) => {
        this.lightStatusOutputWord.setBitValue(28, v);
      },
      true,
      true,
    ),
