...
export class NXSpeeds {
  ...
  public vs = vs[this.fPos][this.cm]();
  public vls = (this.isTo ? vlsTo : vls)[this.fPos][this.cm]();
  public readonly vapp = this.vls + _addWindComponent(this.wind);
  public readonly f = f[this.cm]();
  public readonly s = s[this.cm]();
...
export class NXSpeedsApp {
  private readonly cm = _correctMass(this.m);
  public readonly vls = vls[this.isConf3 ? 3 : 4][this.cm]();
