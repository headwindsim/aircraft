...
import { A330X_DEFAULT_RADIO_AUTO_CALL_OUTS, A330XRadioAutoCallOutFlags } from '@shared/AutoCallOuts';
...
export class A32NX_GPWS {
  private autoCallOutPins = A330X_DEFAULT_RADIO_AUTO_CALL_OUTS;
    ...
    switch (this.AltCallState.value) {
      ...
      case 'over5':
        if (radioAlt > 12) {
          ...
          if (this.RetardState.value !== 'retardPlaying' && this.autoCallOutPins & A330XRadioAutoCallOutFlags.Five) {
      ...
      case 'over10':
        if (radioAlt > 22) {
          ...
          if (this.RetardState.value !== 'retardPlaying' && this.autoCallOutPins & A330XRadioAutoCallOutFlags.Ten) {
      ...
      case 'over20':
        if (radioAlt > 32) {
          ...
          if (this.autoCallOutPins & A330XRadioAutoCallOutFlags.Twenty) {
      ...
      case 'over30':
        if (radioAlt > 42) {
          ...
          if (this.autoCallOutPins & A330XRadioAutoCallOutFlags.Thirty) {
      ...
      case 'over40':
        if (radioAlt > 53) {
          ...
          if (this.autoCallOutPins & A330XRadioAutoCallOutFlags.Forty) {
      ...
      case 'over50':
        if (radioAlt > 63) {
          ...
          if (this.autoCallOutPins & A330XRadioAutoCallOutFlags.Fifty) {
      ...
      case 'over60':
        if (radioAlt > 74) {
          ...
          if (this.autoCallOutPins & A330XRadioAutoCallOutFlags.Sixty) {
      ...
      case 'over70':
        if (radioAlt > 84) {
          ...
          if (this.autoCallOutPins & A330XRadioAutoCallOutFlags.Seventy) {
      ...
      case 'over80':
        if (radioAlt > 94) {
          ...
          if (this.autoCallOutPins & A330XRadioAutoCallOutFlags.Eighty) {
            this.core.soundManager.tryPlaySound(soundList.alt_80);
          }
          this.AltCallState.action('down');
        }
        break;
      case 'over90':
        if (radioAlt > 110) {
          ...
          if (this.autoCallOutPins & A330XRadioAutoCallOutFlags.Ninety) {
            this.core.soundManager.tryPlaySound(soundList.alt_90);
          }
          this.AltCallState.action('down');
        }
        break;
      case 'over100':
        if (radioAlt > 210) {
          ...
          if (this.autoCallOutPins & A330XRadioAutoCallOutFlags.OneHundred) {
      ...
      case 'over200':
        if (radioAlt > 310) {
          ...
          if (this.autoCallOutPins & A330XRadioAutoCallOutFlags.TwoHundred) {
      ...
      case 'over300':
        if (radioAlt > 410) {
          ...
          if (this.autoCallOutPins & A330XRadioAutoCallOutFlags.ThreeHundred) {
      ...
      case 'over400':
        if (radioAlt > 513) {
          ...
          if (this.autoCallOutPins & A330XRadioAutoCallOutFlags.FourHundred) {
      ...
      case 'over500':
        if (radioAlt > 1020) {
          ...
          if (this.autoCallOutPins & A330XRadioAutoCallOutFlags.FiveHundred) {
      ...
      case 'over1000':
        if (radioAlt > 2020) {
          ...
          if (this.autoCallOutPins & A330XRadioAutoCallOutFlags.OneThousand) {
      ...
      case 'over2000':
        if (radioAlt > 2530) {
          ...
          if (this.autoCallOutPins & A330XRadioAutoCallOutFlags.TwoThousand) {
      ...
      case 'over2500':
        if (radioAlt <= 2530) {
          if (this.autoCallOutPins & A330XRadioAutoCallOutFlags.TwoThousandFiveHundred) {
            this.core.soundManager.tryPlaySound(soundList.alt_2500);
          } else if (this.autoCallOutPins & A330XRadioAutoCallOutFlags.TwentyFiveHundred) {
