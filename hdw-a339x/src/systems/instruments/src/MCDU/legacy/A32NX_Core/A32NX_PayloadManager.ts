...
export class A32NX_PayloadConstructor {
  public readonly paxStations = {
    ...
    rows9_15: {
        name: 'ROWS [9-15]',
        seats: 39,
        weight: Math.round(NXUnits.kgToUser(3276)),
        stationIndex: 3,
        position: 20,
        simVar: "A32NX_PAX_C"
    },
    ...
    rows23_26: {
        name: 'ROWS [22-26]',
        seats: 45,
        weight: Math.round(NXUnits.kgToUser(3780)),
        stationIndex: 5,
        position: -10,
        simVar: "A32NX_PAX_E"
    },
    ...
    rows47_54: {
        name: 'ROWS [47-54]',
        seats: 52,
        weight: Math.round(NXUnits.kgToUser(4368)),
        stationIndex: 10,
        position: -80,
        simVar: "A32NX_PAX_J"
    },
  ...
  public readonly cargoStations = {
    fwdBag: {
      name: 'BAGGAGE',
      weight: Math.round(NXUnits.kgToUser(5800)),
      load: 0,
      stationIndex: 11,
      position: 40.00,
      visible: true,
  ...
  aftCont: {
      ...
      weight: Math.round(NXUnits.kgToUser(17061)),
      load: 0,
      stationIndex: 12,
      position: 0.00,
      visible: true,
  ...
  aftBag: {
      ...
      weight: Math.round(NXUnits.kgToUser(18507)),
      load: 0,
      stationIndex: 13,
      position: -55.00,
      visible: true,
  ...
  aftBulk: {
      ...
      weight: Math.round(NXUnits.kgToUser(3468)),
      load: 0,
      stationIndex: 14,
      position: -80.00,
      visible: true,
