...
export const EngPage: FC = () => {
  ...
  return (
    <EcamPage name="main-eng">
      ...
      <text x={300} y={18} className="FillWhite FontMedium TextCenter">
        N2
      </text>
      <text x={300} y={40} className="FillCyan FontSmall TextCenter">
        %
      </text>
...
const EngineColumn = ({ x, y, engineNumber, fadecOn }: ComponentPositionProps) => {
  ...
  const [n3Vibration] = useSimVar(`TURB ENG VIBRATION:${engineNumber}`, 'Number'); // FIXME TODO: should have a different value than N1, currently API limited
