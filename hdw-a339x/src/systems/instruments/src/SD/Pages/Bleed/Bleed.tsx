...
export const BleedPage: FC = () => {
  ...
  return (
    <EcamPage name="main-bleed">
      ...
      <Triangle x={261.33} y={24} colour={indicationBleedUsers} orientation={0} fill={0} scale={0.75} />
      <Triangle x={337.66} y={24} colour={indicationBleedUsers} orientation={0} fill={0} scale={0.75} />
      <Triangle x={414} y={24} colour={indicationBleedUsers} orientation={0} fill={0} scale={0.75} />
