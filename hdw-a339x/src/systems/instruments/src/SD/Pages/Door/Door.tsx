        ...
        <>
            ...
            <svg id="door-page" viewBox="0 0 600 600" style={{ marginTop: '-60px' }} xmlns="http://www.w3.org/2000/svg">
                ...
                <g id="slides">
                    ...
                    <path id="DoorFwdRight" className={catering1 > 20 ? 'WarningShape' : 'DoorShape'} d="M336 145 l0 -20 l-12 0 l0 20Z" />
                    <path id="DoorFwdMiddleLeft" className={cabinMid > 20 ? 'WarningShape' : 'DoorShape'} d="M264 220 l0 -20 l12 0 l0 20Z" />
                    <path id="DoorFwdMiddleRight" className={catering2 > 20 ? 'WarningShape' : 'DoorShape'} d="M336 220 l0 -20 l-12 0 l0 20Z" />
                    ...
                    <path id="DoorAftLeft" className={cabinAft > 20 ? 'WarningShape' : 'DoorShape'} d="M264 445 l0 -20 l12 0 l0 20Z" />
                ...
                <g id="dashes">
                    ...
                    <path id="DoorFwdRightDash" className={catering1 > 20 ? 'WarningShape' : 'Hide'} strokeDasharray="7,4" d="M346, 136 l77 0" />
                    <path id="DoorFwdMiddleLeftDash" className={cabinMid > 20 ? 'WarningShape' : 'Hide'} strokeDasharray="7,4" d="M138, 210 l121 0" />
                    <path id="DoorFwdMiddleRightDash" className={catering2 > 20 ? 'WarningShape' : 'Hide'} strokeDasharray="7,4" d="M346, 210 l77 0" />
                    ...
                    <path id="DoorAftLeftDash" className={cabinAft > 20 ? 'WarningShape' : 'Hide'} strokeDasharray="7,4" d="M138, 438 l121 0" />
                ...
                <g id="texts">
                    ...
                    <text id="FwdDoorRightCabin" className={catering1 > 20 ? 'Warning' : 'Hide'} x="455" y="136" textAnchor="middle" alignmentBaseline="central">CABIN</text>
                    <text id="FwdMiddleDoorLeftCabin" className={cabinMid > 20 ? 'Warning' : 'Hide'} x="103" y="210" textAnchor="middle" alignmentBaseline="central">CABIN</text>
                    <text id="FwdMiddleDoorRightCabin" className={catering2 > 20 ? 'Warning' : 'Hide'} x="455" y="210" textAnchor="middle" alignmentBaseline="central">CABIN</text>
                    ...
                    <text id="AftLeftDoorCabin" className={cabinAft > 20 ? 'Warning' : 'Hide'} x="103" y="438" textAnchor="middle" alignmentBaseline="central">CABIN</text>
