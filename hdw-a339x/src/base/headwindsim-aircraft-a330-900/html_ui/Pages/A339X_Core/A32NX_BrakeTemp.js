...
class A32NX_BrakeTemp {
    constructor() {
        ...
        this.brakes = [
            ...
            new A32NX_OneBrakeTemp(4, 'L:A32NX_BRAKE_TEMPERATURE_5', 'L:A32NX_REPORTED_BRAKE_TEMPERATURE_5', this.gearLeft, this.brakeFan),
            new A32NX_OneBrakeTemp(5, 'L:A32NX_BRAKE_TEMPERATURE_6', 'L:A32NX_REPORTED_BRAKE_TEMPERATURE_6', this.gearLeft, this.brakeFan),
            new A32NX_OneBrakeTemp(6, 'L:A32NX_BRAKE_TEMPERATURE_7', 'L:A32NX_REPORTED_BRAKE_TEMPERATURE_7', this.gearLeft, this.brakeFan),
            new A32NX_OneBrakeTemp(7, 'L:A32NX_BRAKE_TEMPERATURE_8', 'L:A32NX_REPORTED_BRAKE_TEMPERATURE_8', this.gearLeft, this.brakeFan),
        ];
    }
