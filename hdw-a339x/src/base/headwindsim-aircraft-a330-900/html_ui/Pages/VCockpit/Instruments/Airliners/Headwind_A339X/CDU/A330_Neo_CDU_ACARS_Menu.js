    ...
    const updateView = () => {
      mcdu.setTemplate(
        FormatTemplate([
          ...
          [new Column(7, 'F-PLN INIT'), new Column(23, requestEnable ? 'REQ*' : 'REQ ', Column.right)],
          [''],
          [new Column(7, 'TO DATA', Column.inop), new Column(23, 'REQ*', Column.right, Column.inop)],
          [''],
          [
          ...
          [new Column(0, '<RETURN'), new Column(23, 'FUNCTION>', Column.right)],
        ]),
      );
    };
    ...
    const updateView = () => {
      mcdu.setTemplate(
        FormatTemplate([
          ...
          [new Column(5, 'F-PLN RPT'), new Column(23, 'SEND*', Column.right)],
          [''],
          [new Column(5, 'POSITION RPT'), new Column(23, 'SEND*', Column.right)],
          [''],
          [''],
          [''],
          [''],
