class CDU_CMS_TestMenu {
  static ShowPage1(mcdu) {
    ...
    const updateView = () => {
      const getColor = (system, isSelected) =>
        isSelected ? Column.cyan : system === activeSystem ? Column.green : Column.white;

      mcdu.setTemplate(
        FormatTemplate([
          [new Column(1, 'SYSTEM REPORT/TEST 1/6')],
          [new Column(5, 'ATA:21 AIRCOND')],
          [new Column(0, '<AVNCS VENT'), new Column(23, 'TEMP REGUL>', Column.right)],
          [''],
          [new Column(0, '<CARG VENT'), new Column(23, 'PRESS>', Column.right)],
          [new Column(5, 'ATA:22 AFS')],
          [new Column(0, '<AP', Column.inop), new Column(23, 'FD>', Column.inop, Column.right)],
          [''],
          [new Column(0, '<SPEED LIMIT', Column.inop), new Column(23, 'FM>', Column.inop, Column.right)],
          [''],
          [new Column(0, '<WIND SHEAR', Column.inop), new Column(23, 'A-THR>', Column.inop, Column.right)],
          [''],
    ...
    const updateView = () => {
      ...
      mcdu.setTemplate(
        FormatTemplate([
          ...
          [new Column(0, '<RADIO', Column.inop), new Column(23, 'CABIN>', Column.inop, Column.right)],
          [''],
          [new Column(0, '<EMERG & DISPLAY LIGHTS', Column.inop)],
          [new Column(5, 'ATA:24 ELEC')],
          [new Column(0, '<AC'), new Column(6, 'GENERATION'), new Column(23, 'DC>', Column.right)],
          [new Column(5, 'ATA:26 FIRE PROT')],
          [new Column(0, '<ENGINES', Column.inop), new Column(23, 'SMOKE/LAV>', Column.inop, Column.right)],
          [new Column(5, 'ATA:27 F/CTRL')],
          [new Column(0, '<FLAP/SLAT', Column.inop), new Column(23, 'ELEC FLIGHT>', Column.inop, Column.right)],
    ...
    const updateView = () => {
      ...
      mcdu.setTemplate(
        FormatTemplate([
          ...
          [new Column(0, '<WINDOWW', Column.inop), new Column(23, 'PROBES>', Column.inop, Column.right)],
          [new Column(5, 'ATA:31 INST')],
          [new Column(0, '<DISPLAY'), new Column(23, 'WARNING>', Column.right)],
          [''],
    ...
    const updateView = () => {
      ...
      mcdu.setTemplate(
        FormatTemplate([
          ...
          [new Column(0, '<STEERING', Column.inop), new Column(23, 'EXT/RETR>', Column.inop, Column.right)],
          [''],
          ['', new Column(23, 'BRAKING>', Column.inop, Column.right)],
          [new Column(5, 'ATA:34 NAV')],
          [new Column(0, '<ALTITUDE', Column.inop), new Column(23, 'SPEED/TEMP>', Column.inop, Column.right)],
          [''],
          [new Column(0, '<RADIO NAV', Column.inop), new Column(23, 'ATTITUDE>', Column.inop, Column.right)],
          [''],
          [''],
          [''],
          [new Column(0, '<RETURN', getColor('RETURN', selectedReturn))],
    ...
    const updateView = () => {
      ...
      mcdu.setTemplate(
        FormatTemplate([
          ...
          [new Column(0, '<VIBRATION', Column.inop), new Column(23, 'START/IGNIT>', Column.inop, Column.right)],
          [''],
          [new Column(0, '<INTERFACE', Column.inop), new Column(23, 'INDICATING>', Column.inop, Column.right)],
          [''],
          [new Column(0, '<FADEC STATUS REVERSERS', Column.inop)],
          [''],
          [new Column(0, '<OTHERS', Column.inop), new Column(23, 'AUTO THRUST>', Column.inop, Column.right)],
          [''],
          [new Column(0, '<RETURN', getColor('RETURN', selectedReturn))],
        ]),
      );
