class CDU_SAT_ManualDial {
  static ShowPage(mcdu) {
    ...
    const [phoneNumberAction, phoneNumberText, phoneNumberColor] = new CDU_SingleValueField(
      mcdu,
      'string',
    ...
    const updateView = () => {
      mcdu.setTemplate(
        FormatTemplate([
          ...
          [''],
          [new Column(0, '<RETURN', Column.cyan), new Column(23, 'PRE-SELECT*', Column.cyan, Column.right)],
        ]),
      );
    };
