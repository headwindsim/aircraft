class CDUInitPage {
  static ShowPage1(mcdu) {
    ...
    const haveFlightPlan = mcdu.flightPlanManager.getPersistentOrigin() && mcdu.flightPlanManager.getDestination();
    ...
    if (mcdu.flightPlanManager.getPersistentOrigin() && mcdu.flightPlanManager.getPersistentOrigin().ident) {
      if (mcdu.flightPlanManager.getDestination() && mcdu.flightPlanManager.getDestination().ident) {
        fromTo.update(
          mcdu.flightPlanManager.getPersistentOrigin().ident + '/' + mcdu.flightPlanManager.getDestination().ident,
          Column.cyan,
        );
        ...
        if (
          ...
          (mcdu.simbrief['originIcao'] === mcdu.flightPlanManager.getPersistentOrigin().ident &&
            mcdu.simbrief['destinationIcao'] === mcdu.flightPlanManager.getDestination().ident)
        ) {
          requestEnable = false;
          requestButtonLabel = '';
          requestButton = '';
         ...
         * flight.
         */
        [paxNoAction, paxNoText, paxNoColor] = new CDU_SingleValueField(
          mcdu,
          'int',
        ...
        if (mcdu._cruiseEntered && mcdu._cruiseFlightLevel) {
          ...
          if (mcdu.cruiseTemperature) {
            ...
            cruiseTemp.update(
              mcdu.tempCurve.evaluate(mcdu._cruiseFlightLevel).toFixed(0) + '°',
              Column.cyan,
              Column.small,
            );
    ...
    mcdu.setTemplate(
      FormatTemplate([
        ...
        [new Column(0, paxNoText, paxNoColor), new Column(23, 'WIND>', Column.right)],
  ...
  static ShowPage2(mcdu) {
    ...
    if (
      mcdu.flightPlanManager.getPersistentOrigin() &&
      mcdu.flightPlanManager.getPersistentOrigin().ident &&
      mcdu.flightPlanManager.getDestination() &&
      mcdu.flightPlanManager.getDestination().ident
    ) {
