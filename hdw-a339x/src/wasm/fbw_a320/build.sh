...
COMMON_DIR="${DIR}/../../../../build-a339x-common/src/wasm/fbw_common"
OUTPUT="${DIR}/../../../../build-a339x/out/headwindsim-aircraft-a330-900/SimObjects/Airplanes/Headwind_A330_900/panel/fbw.wasm"
