...
void AutopilotLawsModelClass::step()
{
  ...
  AutopilotLaws_LagFilter(Phi2 + AutopilotLaws_P.Gain3_Gain_i * AutopilotLaws_DWork.DelayInput1_DSTATE,
    AutopilotLaws_P.LagFilter_C1, AutopilotLaws_U.in.time.dt, &rtb_Y_o, &AutopilotLaws_DWork.sf_LagFilter_m);
  ...
  AutopilotLaws_MATLABFunction_m(AutopilotLaws_U.in.input.Psi_c_deg, Phi2, rtb_Sum_i, &rtb_Y_m, &rtb_lo_k,
  ...
  switch (static_cast<int32_T>(rtb_error_d)) {
   ...
   case 5:
    ...
    rtb_Add3_j4 = (rtb_Y_o * look1_binlxpw(AutopilotLaws_U.in.data.V_tas_kn,
  ...
  AutopilotLaws_LagFilter(AutopilotLaws_P.Gain_Gain_lu * (AutopilotLaws_DWork.DelayInput1_DSTATE - rtb_GainTheta1),
    AutopilotLaws_P.LagFilter_C1_a, AutopilotLaws_U.in.time.dt, &rtb_Y_o, &AutopilotLaws_DWork.sf_LagFilter_mp);
  AutopilotLaws_RateLimiter_n(rtb_Compare_l, AutopilotLaws_P.RateLimiterVariableTs_up_n,
    ...
    AutopilotLaws_P.RateLimiterVariableTs_InitialCondition_i, &rtb_Y_m, &AutopilotLaws_DWork.sf_RateLimiter_e);
  if (rtb_Y_m > AutopilotLaws_P.Saturation_UpperSat_k) {
    rtb_Sum_kq = AutopilotLaws_P.Saturation_UpperSat_k;
  } else if (rtb_Y_m < AutopilotLaws_P.Saturation_LowerSat_f3) {
  ...
  AutopilotLaws_LagFilter(rtb_dme, AutopilotLaws_P.LagFilter1_C1, AutopilotLaws_U.in.time.dt, &rtb_Y_m,
  ...
  switch (static_cast<int32_T>(rtb_error_d)) {
   ...
   case 5:
    if (rtb_Y_m > AutopilotLaws_P.Saturation_UpperSat_e) {
      rtb_Saturation = AutopilotLaws_P.Saturation_UpperSat_e;
    } else if (rtb_Y_m < AutopilotLaws_P.Saturation_LowerSat_f) {
      rtb_Saturation = AutopilotLaws_P.Saturation_LowerSat_f;
    } else {
      rtb_Saturation = rtb_Y_m;
    }
    break;
  ...
  AutopilotLaws_RateLimiter(static_cast<real_T>(rtb_fpmtoms), AutopilotLaws_P.RateLimiterVariableTs_up_b,
    ...
    AutopilotLaws_P.RateLimiterVariableTs_InitialCondition_il, &rtb_Y_m, &AutopilotLaws_DWork.sf_RateLimiter_d);
  if (rtb_Y_m > AutopilotLaws_P.Saturation_UpperSat_m) {
    AutopilotLaws_DWork.DelayInput1_DSTATE = AutopilotLaws_P.Saturation_UpperSat_m;
  } else if (rtb_Y_m < AutopilotLaws_P.Saturation_LowerSat_fw) {
    AutopilotLaws_DWork.DelayInput1_DSTATE = AutopilotLaws_P.Saturation_LowerSat_fw;
  } else {
    AutopilotLaws_DWork.DelayInput1_DSTATE = rtb_Y_m;
  }
  ...
  AutopilotLaws_Y.out.output.flight_director.Phi_c_deg = rtb_Y_o;
  ...
  AutopilotLaws_LagFilter(AutopilotLaws_B.u - AutopilotLaws_U.in.data.H_ft, AutopilotLaws_P.LagFilter_C1_ai,
    AutopilotLaws_U.in.time.dt, &rtb_Y_m, &AutopilotLaws_DWork.sf_LagFilter_g);
  AutopilotLaws_DWork.DelayInput1_DSTATE += AutopilotLaws_P.Gain_Gain_ft * rtb_Y_m;
  ...
  AutopilotLaws_WashoutFilter(AutopilotLaws_P._Gain * (AutopilotLaws_P.GStoGS_CAS_Gain * (AutopilotLaws_P.ktstomps_Gain *
    AutopilotLaws_U.in.data.V_gnd_kn)), AutopilotLaws_P.WashoutFilter_C1_e, AutopilotLaws_U.in.time.dt, &rtb_Y_m,
  ...
  AutopilotLaws_LeadLagFilter(rtb_Y_m - AutopilotLaws_P.g_Gain * (AutopilotLaws_P.Gain1_Gain_lp *
  ...
  AutopilotLaws_LeadLagFilter(AutopilotLaws_P.ktstomps_Gain_b * AutopilotLaws_U.in.data.V_ias_kn,
    ...
    AutopilotLaws_P.LowPassFilter_C4, AutopilotLaws_U.in.time.dt, &rtb_Y_m, &AutopilotLaws_DWork.sf_LeadLagFilter_o);
  R = (rtb_Y_pf + rtb_Y_m) * AutopilotLaws_P.ug_Gain;
  ...
  AutopilotLaws_V_LSSpeedSelection1(AutopilotLaws_U.in.input.V_c_kn, AutopilotLaws_U.in.data.VLS_kn, &rtb_Y_m);
  rtb_lo_b = (AutopilotLaws_U.in.data.V_ias_kn - rtb_Y_m) * AutopilotLaws_P.Gain1_Gain_oz;
  if (rtb_lo_b <= R) {
  ...
  AutopilotLaws_WashoutFilter(AutopilotLaws_P._Gain_h * (AutopilotLaws_P.GStoGS_CAS_Gain_m *
    ...
    AutopilotLaws_U.in.time.dt, &rtb_Y_m, &AutopilotLaws_DWork.sf_WashoutFilter_d);
  ...
  AutopilotLaws_LeadLagFilter(rtb_Y_m - AutopilotLaws_P.g_Gain_h * (AutopilotLaws_P.Gain1_Gain_dv *
  ...
  AutopilotLaws_LeadLagFilter(AutopilotLaws_P.ktstomps_Gain_i * AutopilotLaws_U.in.data.V_ias_kn,
    ...
    AutopilotLaws_P.LowPassFilter_C4_o, AutopilotLaws_U.in.time.dt, &rtb_Y_m, &AutopilotLaws_DWork.sf_LeadLagFilter_m);
  R = (rtb_Y_pf + rtb_Y_m) * AutopilotLaws_P.ug_Gain_a;
  ...
  rtb_Y_m = AutopilotLaws_U.in.data.V_ias_kn - AutopilotLaws_U.in.data.VMAX_kn;
  rtb_Gain1_pj = rtb_Y_m * AutopilotLaws_P.Gain1_Gain_f1;
  if (rtb_Gain1_pj <= R) {
  ...
  rtb_Y_o = AutopilotLaws_P.Gain_Gain_ey * std::asin(rtb_Add3_j4);
  ...
  rtb_Cos1_pk = rtb_Y_m * AutopilotLaws_P.Gain1_Gain_gy;
  ...
  AutopilotLaws_SpeedProtectionSignalSelection(&AutopilotLaws_Y.out, rtb_Y_o, std::fmax(-rtb_Y_pf, std::fmin(rtb_Y_pf,
    AutopilotLaws_P.VS_Gain_h * rtb_Y_o)), rtb_Add3_g, AutopilotLaws_P.Gain_Gain_h4 * rtb_Add3_g, Phi2,
  ...
  AutopilotLaws_WashoutFilter(AutopilotLaws_P._Gain_kb * (AutopilotLaws_P.GStoGS_CAS_Gain_o *
    AutopilotLaws_DWork.DelayInput1_DSTATE), AutopilotLaws_P.WashoutFilter_C1_j, AutopilotLaws_U.in.time.dt, &rtb_Y_o,
  ...
  AutopilotLaws_LeadLagFilter(AutopilotLaws_P.ktstomps_Gain_k * AutopilotLaws_U.in.data.V_ias_kn,
    ...
    AutopilotLaws_P.LowPassFilter_C4_dt, AutopilotLaws_U.in.time.dt, &rtb_Y_o, &AutopilotLaws_DWork.sf_LeadLagFilter_kp);
  AutopilotLaws_DWork.DelayInput1_DSTATE = (rtb_Gain1_pj + rtb_Y_o) * AutopilotLaws_P.ug_Gain_n;
  ...
  rtb_Y_o = (AutopilotLaws_U.in.data.V_ias_kn - rtb_Y_o) * AutopilotLaws_P.Gain1_Gain_m1;
  if (rtb_Y_o <= AutopilotLaws_DWork.DelayInput1_DSTATE) {
    ...
    if (rtb_Y_o >= AutopilotLaws_DWork.DelayInput1_DSTATE) {
      AutopilotLaws_DWork.DelayInput1_DSTATE = rtb_Y_o;
    }
  }
  ...
  AutopilotLaws_WashoutFilter(AutopilotLaws_P._Gain_ip * (AutopilotLaws_P.GStoGS_CAS_Gain_e *
    AutopilotLaws_DWork.DelayInput1_DSTATE), AutopilotLaws_P.WashoutFilter_C1_c, AutopilotLaws_U.in.time.dt, &rtb_Y_o,
  ...
  AutopilotLaws_DWork.DelayInput1_DSTATE = (rtb_Gain1_pj + rtb_Y_o) * AutopilotLaws_P.ug_Gain_e;
  R = AutopilotLaws_P.Gain1_Gain_be * Phi2;
  rtb_Gain1_pj = AutopilotLaws_DWork.DelayInput1_DSTATE + R;
  rtb_Y_o = AutopilotLaws_P.Constant1_Value_o - AutopilotLaws_P.Constant2_Value_h;
  R = (AutopilotLaws_P.Gain1_Gain_nj * AutopilotLaws_DWork.DelayInput1_DSTATE + R) * AutopilotLaws_P.Gain_Gain_aq;
  if (rtb_Y_o > AutopilotLaws_P.Switch_Threshold_g) {
  ...
  rtb_Y_m *= AutopilotLaws_P.Gain1_Gain_fle;
  if (rtb_Y_m <= AutopilotLaws_DWork.DelayInput1_DSTATE) {
    if (rtb_Y_o > AutopilotLaws_P.Switch1_Threshold_h) {
  ...
  AutopilotLaws_LagFilter(AutopilotLaws_U.in.data.nav_gs_error_deg, AutopilotLaws_P.LagFilter2_C1_e,
    AutopilotLaws_U.in.time.dt, &rtb_Y_o, &AutopilotLaws_DWork.sf_LagFilter_cf);
  rtb_Add3_i = AutopilotLaws_P.DiscreteDerivativeVariableTs_Gain_g * rtb_Y_o;
  ...
  AutopilotLaws_LagFilter(rtb_Y_o + (rtb_Add3_i - AutopilotLaws_DWork.Delay_DSTATE_b) / AutopilotLaws_U.in.time.dt *
  ...
  rtb_Y_o = AutopilotLaws_P.Gain5_Gain_c * AutopilotLaws_U.in.data.bz_m_s2;
  ...
  AutopilotLaws_LagFilter(AutopilotLaws_U.in.data.H_dot_ft_min, AutopilotLaws_P.LagFilterH_C1,
    AutopilotLaws_U.in.time.dt, &rtb_Y_m, &AutopilotLaws_DWork.sf_LagFilter_a);
  Phi2 = rtb_Y_m - AutopilotLaws_P.kntofpm_Gain * AutopilotLaws_U.in.data.V_gnd_kn * AutopilotLaws_P.maxslope_Gain;
  ...
  AutopilotLaws_DWork.DelayInput1_DSTATE = AutopilotLaws_P.Gain1_Gain_oa * rtb_Y_m;
  ...
  switch (static_cast<int32_T>(rtb_error_d)) {
   ...
   case 7:
    if (rtb_on_ground > AutopilotLaws_P.Switch1_Threshold_j) {
      ...
      b_L = ((AutopilotLaws_P.Gain1_Gain_i * rtb_Y_pf + rtb_Y_o) + rtb_Sum1_g * rtb_uDLookupTable_m) *
  ...
  if (rtb_on_ground <= AutopilotLaws_P.Switch_Threshold_c) {
    rtb_Gain4 = ((rtb_Y_o + a) + rtb_uDLookupTable_m * b_L) + rtb_Saturation;
  }
  ...
  AutopilotLaws_LagFilter(rtb_Y_m, AutopilotLaws_P.LagFilter1_C1_d, AutopilotLaws_U.in.time.dt, &rtb_dme,
  ...
  AutopilotLaws_Y.out.output.flare_law.delta_Theta_bz_deg = rtb_Y_o;
