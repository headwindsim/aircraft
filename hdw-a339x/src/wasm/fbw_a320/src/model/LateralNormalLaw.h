...
class LateralNormalLaw final
{
 public:
  ...
  struct rtDW_LagFilter_LateralNormalLaw_T {
    real_T pY;
    real_T pU;
    boolean_T pY_not_empty;
 ...
 private:
  ...
  static void LateralNormalLaw_LagFilter_Reset(rtDW_LagFilter_LateralNormalLaw_T *localDW);
  static void LateralNormalLaw_LagFilter(real_T rtu_U, real_T rtu_C1, const real_T *rtu_dt, real_T *rty_Y,
