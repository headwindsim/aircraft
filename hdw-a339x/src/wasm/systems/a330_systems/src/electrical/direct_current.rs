...
pub(super) struct A330DirectCurrentElectrical {
...
impl A330DirectCurrentElectrical {
    pub fn new(context: &mut InitContext) -> Self {
        A330DirectCurrentElectrical {
    ...
    pub fn update(
        ...
        ac_state: &impl A330AlternatingCurrentElectricalSystem,
...
impl A330DirectCurrentElectricalSystem for A330DirectCurrentElectrical {
    fn static_inverter(&self) -> &StaticInverter {
        &self.static_inverter
    }
}
impl SimulationElement for A330DirectCurrentElectrical {
