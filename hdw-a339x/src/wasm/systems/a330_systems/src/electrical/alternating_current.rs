use super::{
    A330AlternatingCurrentElectricalSystem, A330DirectCurrentElectricalSystem,
    A330ElectricalOverheadPanel, A330EmergencyElectricalOverheadPanel,
};
...
pub(super) struct A330AlternatingCurrentElectrical {
    main_power_sources: A330MainPowerSources,
    ac_ess_feed_contactors: A330AcEssFeedContactors,
...
impl A330AlternatingCurrentElectrical {
    pub fn new(context: &mut InitContext) -> Self {
        A330AlternatingCurrentElectrical {
            main_power_sources: A330MainPowerSources::new(context),
            ac_ess_feed_contactors: A330AcEssFeedContactors::new(context),
    ...
    pub fn update_after_direct_current(
        ...
        electricity: &mut Electricity,
        emergency_generator: &EmergencyGenerator,
        dc_state: &impl A330DirectCurrentElectricalSystem,
    ) {
...
impl A330AlternatingCurrentElectricalSystem for A330AlternatingCurrentElectrical {
...
impl AlternatingCurrentElectricalSystem for A330AlternatingCurrentElectrical {
...
impl SimulationElement for A330AlternatingCurrentElectrical {
...
impl A330MainPowerSources {
    fn new(context: &mut InitContext) -> Self {
        A330MainPowerSources {
            engine_1_gen: IntegratedDriveGenerator::new(
                context,
                1,
                Power::new::<kilowatt>(115.),
                390.0..=410.0,
            ),
...
impl SimulationElement for A330MainPowerSources {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
...
pub(super) struct A330AcEssFeedContactors {
...
impl SimulationElement for A330AcEssFeedContactors {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
