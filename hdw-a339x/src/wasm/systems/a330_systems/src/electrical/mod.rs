...
use self::{
    alternating_current::A330AlternatingCurrentElectrical,
    direct_current::A330DirectCurrentElectrical,
...
pub(super) struct A330Electrical {
...
impl A330Electrical {
    ...
    pub fn new(context: &mut InitContext) -> A330Electrical {
        A330Electrical {
            galley_is_shed_id: context.get_identifier("ELEC_GALLEY_IS_SHED".to_owned()),
            alternating_current: A330AlternatingCurrentElectrical::new(context),
            direct_current: A330DirectCurrentElectrical::new(context),
    ...
    pub fn update(
        ...
        overhead: &A330ElectricalOverheadPanel,
        emergency_overhead: &A330EmergencyElectricalOverheadPanel,
...
impl SimulationElement for A330Electrical {
...
impl EmergencyElectricalState for A330Electrical {
    fn is_in_emergency_elec(&self) -> bool {
        self.in_emergency_elec()
    }
}
impl EmergencyGeneratorPower for A330Electrical {
    fn generated_power(&self) -> Power {
        self.emergency_gen.generated_power()
    }
}

trait A330DirectCurrentElectricalSystem {
    fn static_inverter(&self) -> &StaticInverter;
}

trait A330AlternatingCurrentElectricalSystem: AlternatingCurrentElectricalSystem {
...
pub(super) struct A330ElectricalOverheadPanel {
...
impl A330ElectricalOverheadPanel {
    pub fn new(context: &mut InitContext) -> A330ElectricalOverheadPanel {
        A330ElectricalOverheadPanel {
            batteries: [
...
impl EngineGeneratorPushButtons for A330ElectricalOverheadPanel {
...
impl BatteryPushButtons for A330ElectricalOverheadPanel {
    fn bat_is_auto(&self, number: usize) -> bool {
        self.batteries[number - 1].is_auto()
    }
}
impl SimulationElement for A330ElectricalOverheadPanel {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
...
pub(super) struct A330EmergencyElectricalOverheadPanel {
...
impl A330EmergencyElectricalOverheadPanel {
...
impl SimulationElement for A330EmergencyElectricalOverheadPanel {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
...
impl EmergencyElectricalRatPushButton for A330EmergencyElectricalOverheadPanel {
...
mod A330_electrical {
    ...
    #[test]
    fn writes_its_state() {
        let mut test_bed = SimulationTestBed::from(ElementCtorFn(A330Electrical::new));
...
#[cfg(test)]
mod A330_electrical_circuit_tests {
    use super::{alternating_current::A330AcEssFeedContactors, *};
    use rstest::rstest;
    ...
    /// # Source
    /// A330 manual electrical distribution table
    #[test]
    ...
    /// # Source
    /// Derived from A330 manual electrical distribution table
    ...
    fn test_bed_with() -> A330ElectricalTestBed {
        test_bed()
    }

    fn test_bed() -> A330ElectricalTestBed {
        A330ElectricalTestBed::new()
    }
    ...
    struct A330ElectricalTestAircraft {
    ...
    impl A330ElectricalTestAircraft {
        fn new(context: &mut InitContext) -> Self {
            Self {
                engines: [TestEngine::new(), TestEngine::new()],
                ext_pwr: ExternalPowerSource::new(context, 1),
                elec: A330Electrical::new(context),
                overhead: A330ElectricalOverheadPanel::new(context),
                emergency_overhead: A330EmergencyElectricalOverheadPanel::new(context),
    ...
    impl Aircraft for A330ElectricalTestAircraft {
    ...
    impl SimulationElement for A330ElectricalTestAircraft {
        fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
            self.ext_pwr.accept(visitor);
    ...
    struct A330ElectricalTestBed {
        test_bed: SimulationTestBed<A330ElectricalTestAircraft>,
    }
    impl A330ElectricalTestBed {
        fn new() -> Self {
            Self {
                test_bed: SimulationTestBed::new(A330ElectricalTestAircraft::new),
            }
        }
        ...
        fn both_ac_ess_feed_contactors_open(&mut self) -> bool {
            !ReadByName::<A330ElectricalTestBed, bool>::read_by_name(
                self,
        ...
        fn run_waiting_for_ac_ess_feed_transition(self) -> Self {
            self.run_waiting_for(A330AcEssFeedContactors::AC_ESS_FEED_TO_AC_BUS_2_DELAY_IN_SECONDS)
        }

        fn run_waiting_until_just_before_ac_ess_feed_transition(self) -> Self {
            self.run_waiting_for(
                A330AcEssFeedContactors::AC_ESS_FEED_TO_AC_BUS_2_DELAY_IN_SECONDS
                    - Duration::from_millis(1),
            )
        }
    }
    impl TestBed for A330ElectricalTestBed {
        type Aircraft = A330ElectricalTestAircraft;

        fn test_bed(&self) -> &SimulationTestBed<A330ElectricalTestAircraft> {
            &self.test_bed
        }

        fn test_bed_mut(&mut self) -> &mut SimulationTestBed<A330ElectricalTestAircraft> {
            &mut self.test_bed
        }
    }
}
