...
impl From<A330Pax> for usize {
    fn from(value: A330Pax) -> Self {
        value as usize
    }
}
impl From<usize> for A330Pax {
    fn from(value: usize) -> Self {
        match value {
            ...
            8 => A330Pax::I,
            9 => A330Pax::J,
            i => panic!("Cannot convert from {} to A330Pax.", i),
        }
    }
}
...
#[cfg(test)]
impl From<usize> for A330Cargo {
    fn from(value: usize) -> Self {
        match value {
            0 => A330Cargo::FwdBaggage,
            1 => A330Cargo::AftContainer,
            2 => A330Cargo::AftBaggage,
            3 => A330Cargo::AftBulkLoose,
            i => panic!("Cannot convert from {} to A330Cargo.", i),
        }
    }
}

pub struct A330Payload {
    payload_manager: PayloadManager<10, 2, 4>,
}
impl A330Payload {
    ...
    const A330_CARGO: [CargoInfo<'_>; 4] = [
        CargoInfo {
            max_cargo_kg: 5800.,
            position: (40.0, 0., 0.),
    ...
    pub fn new(context: &mut InitContext) -> Self {
        ...
        let cargo = Self::A330_CARGO.map(|c| {
            Cargo::new(
...
impl NumberOfPassengers for A330Payload {
    fn number_of_passengers(&self, ps: usize) -> i8 {
        self.pax_num(ps)
    }
}
impl PassengerPayload for A330Payload {
    fn total_passenger_load(&self) -> Mass {
...
impl CargoPayload for A330Payload {
...
impl SimulationElement for A330Payload {
