...
mod tests {
    ...
    impl Aircraft for A330FlapsTestAircraft {
    ...
    impl SimulationElement for A330FlapsTestAircraft {
        fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
    ...
    struct A330FlapsTestBed {
        test_bed: SimulationTestBed<A330FlapsTestAircraft>,
    }

    impl A330FlapsTestBed {
        const HYD_TIME_STEP_MILLIS: u64 = 33;

        fn new() -> Self {
            Self {
                test_bed: SimulationTestBed::new(A330FlapsTestAircraft::new),
            }
        }
    ...
    impl TestBed for A330FlapsTestBed {
        type Aircraft = A330FlapsTestAircraft;

        fn test_bed(&self) -> &SimulationTestBed<A330FlapsTestAircraft> {
            &self.test_bed
        }

        fn test_bed_mut(&mut self) -> &mut SimulationTestBed<A330FlapsTestAircraft> {
            &mut self.test_bed
        }
    }

    fn test_bed() -> A330FlapsTestBed {
        A330FlapsTestBed::new()
    }

    fn test_bed_with() -> A330FlapsTestBed {
        test_bed()
    }
