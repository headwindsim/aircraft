...
impl A320Pax {
    pub fn iterator() -> impl Iterator<Item = A320Pax> {
        [A320Pax::A, A320Pax::B, A320Pax::C, A320Pax::D, A320Pax::E, A320Pax::F, A320Pax::G, A320Pax::H, A320Pax::I, A320Pax::J]
            .iter()
            .copied()
    }
}
...
lazy_static! {
    static ref A320_PAX: EnumMap<A320Pax, PaxInfo> = EnumMap::from_array([
        ...
        PaxInfo::new(36, "PAX_B", "PAYLOAD_STATION_2_REQ",),
        PaxInfo::new(39, "PAX_C", "PAYLOAD_STATION_3_REQ",),
        PaxInfo::new(48, "PAX_D", "PAYLOAD_STATION_4_REQ",),
        PaxInfo::new(45, "PAX_E", "PAYLOAD_STATION_5_REQ",),
        PaxInfo::new(45, "PAX_F", "PAYLOAD_STATION_6_REQ",),
        PaxInfo::new(45, "PAX_G", "PAYLOAD_STATION_7_REQ",),
        PaxInfo::new(45, "PAX_H", "PAYLOAD_STATION_8_REQ",),
        PaxInfo::new(45, "PAX_I", "PAYLOAD_STATION_9_REQ",),
        PaxInfo::new(52, "PAX_J", "PAYLOAD_STATION_10_REQ",)
    ]);
    static ref A320_CARGO: EnumMap<A320Cargo, CargoInfo> = EnumMap::from_array([
        CargoInfo::new(
            Mass::new::<kilogram>(5800.),
            "CARGO_FWD_BAGGAGE_CONTAINER",
            "PAYLOAD_STATION_11_REQ",
        ),
        CargoInfo::new(
            Mass::new::<kilogram>(17061.),
            "CARGO_AFT_CONTAINER",
            "PAYLOAD_STATION_12_REQ",
        ),
        CargoInfo::new(
            Mass::new::<kilogram>(18507.),
            "CARGO_AFT_BAGGAGE",
            "PAYLOAD_STATION_13_REQ",
        ),
        CargoInfo::new(
            Mass::new::<kilogram>(3468.),
            "CARGO_AFT_BULK_LOOSE",
            "PAYLOAD_STATION_14_REQ",
        )
    ]);
}
