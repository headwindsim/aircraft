...
COMMON_DIR="${DIR}/../../../../build-a339x-common/src/wasm"
OUTPUT="${DIR}/../../../../build-a339x/out/headwindsim-aircraft-a330-900/SimObjects/Airplanes/Headwind_A330neo/panel/flypad-backend.wasm"
