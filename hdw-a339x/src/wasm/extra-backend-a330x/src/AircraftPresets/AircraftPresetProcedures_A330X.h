...
#ifndef FLYBYWIRE_AIRCRAFT_AIRCRAFTPRESETPROCEDURES_A330X_H
#define FLYBYWIRE_AIRCRAFT_AIRCRAFTPRESETPROCEDURES_A330X_H
 ...
 */
class AircraftPresetProcedures_A330X {
 public:
...
#endif  // FLYBYWIRE_AIRCRAFT_AIRCRAFTPRESETPROCEDURES_A330X_H
