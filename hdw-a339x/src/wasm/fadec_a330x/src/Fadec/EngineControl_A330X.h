...
#ifndef FLYBYWIRE_AIRCRAFT_ENGINECONTROL_A330X_H
#define FLYBYWIRE_AIRCRAFT_ENGINECONTROL_A330X_H

#include "MsfsHandler.h"

#include "FadecSimData_A330X.hpp"
...
/**
 * @class EngineControl_A330X
 * @brief Manages the engine control for the A330XX aircraft, coordinating and synchronising the
 ...
 *
 * TODO: The EngineControl_A330X class is still work in progress and might be extended or replaced in the future.
 */
class EngineControl_A330X {
 private:
  ...
  SimpleProfiler profilerUpdate{"Fadec::EngineControl_A330X::update()", 100};
  SimpleProfiler profilerEngineStateMachine{"Fadec::EngineControl_A330X::engineStateMachine()", 100};
  SimpleProfiler profilerEngineStartProcedure{"Fadec::EngineControl_A330X::engineStartProcedure()", 100};
  SimpleProfiler profilerEngineShutdownProcedure{"Fadec::EngineControl_A330X::engineShutdownProcedure()", 100};
  SimpleProfiler profilerUpdateFF{"Fadec::EngineControl_A330X::updateFF()", 100};
  SimpleProfiler profilerUpdatePrimaryParameters{"Fadec::EngineControl_A330X::updatePrimaryParameters()", 100};
  SimpleProfiler profilerUpdateSecondaryParameters{"Fadec::EngineControl_A330X::updateSecondaryParameters()", 100};
  SimpleProfiler profilerUpdateEGT{"Fadec::EngineControl_A330X::updateEGT()", 100};
  SimpleProfiler profilerUpdateFuel{"Fadec::EngineControl_A330X::updateFuel()", 100};
  SimpleProfiler profilerUpdateThrustLimits{"Fadec::EngineControl_A330X::updateThrustLimits()", 100};
#endif
 ...
 private:
   ...
   * @param simN3 The current N2 value from the simulator in percent used as N3 input in the A330X.
   */
...
#endif  // FLYBYWIRE_AIRCRAFT_ENGINECONTROL_A330X_H
