...
void FcuComputer::step()
{
  ...
  boolean_T rtb_BusAssignment_d_baro_qnh;
  ...
  if (FcuComputer_U.in.sim_data.computer_running) {
    if (!FcuComputer_DWork.Runtime_MODE) {
      ...
      FcuComputer_DWork.pValue_not_empty_j = false;
    ...
    rtb_fmgc1Priority = (FcuComputer_U.in.discrete_inputs.ap_1_engaged ||
                         ((!FcuComputer_U.in.discrete_inputs.ap_2_engaged) &&
                          FcuComputer_U.in.discrete_inputs.fd_1_engaged) ||
                         ((!FcuComputer_U.in.discrete_inputs.ap_2_engaged) &&
                          (!FcuComputer_U.in.discrete_inputs.fd_2_engaged) &&
                          FcuComputer_U.in.discrete_inputs.athr_1_engaged) ||
                         ((!FcuComputer_U.in.discrete_inputs.ap_2_engaged) &&
                          (!FcuComputer_U.in.discrete_inputs.fd_2_engaged) &&
    ...
    FcuComputer_MATLABFunction_i(rtb_Switch1_b_0, FcuComputer_P.A429ValueOrDefault1_defaultValue, &rtb_y_k);
    FcuComputer_MATLABFunction_i(rtb_Switch_heading_deg, FcuComputer_P.A429ValueOrDefault2_defaultValue, &rtb_y_g);
    FcuComputer_MATLABFunction_i(rtb_Switch_track_deg, FcuComputer_P.A429ValueOrDefault3_defaultValue, &rtb_y_pk);
    ...
    FcuComputer_MATLABFunction((FcuComputer_U.in.discrete_inputs.afs_inputs.hdg_trk_knob.turns !=
      FcuComputer_P.CompareToConstant_const), FcuComputer_U.in.time.dt, &rtb_dashes_h,
    ...
    rtb_BusAssignment_m.logic.afs.hdg_trk_buttons.turns = static_cast<int8_T>(rtb_dashes_h);
    ...
    FcuComputer_MATLABFunction((FcuComputer_U.in.discrete_inputs.afs_inputs.spd_knob.turns !=
      FcuComputer_P.CompareToConstant_const_p), FcuComputer_U.in.time.dt, &rtb_dashes_h,
    ...
    rtb_BusAssignment_m.logic.afs.spd_mach_buttons.turns = static_cast<int8_T>(rtb_dashes_h);
    ...
    FcuComputer_MATLABFunction((FcuComputer_U.in.discrete_inputs.afs_inputs.alt_knob.turns !=
      FcuComputer_P.CompareToConstant_const_pg), FcuComputer_U.in.time.dt, &rtb_dashes_h,
    ...
    rtb_BusAssignment_m.logic.afs.alt_buttons.turns = static_cast<int8_T>(rtb_dashes_h);
    ...
    FcuComputer_MATLABFunction((FcuComputer_U.in.discrete_inputs.afs_inputs.vs_fpa_knob.turns !=
      FcuComputer_P.CompareToConstant_const_e), FcuComputer_U.in.time.dt, &rtb_dashes_h,
    ...
    rtb_BusAssignment_m.logic.afs.vs_fpa_buttons.turns = static_cast<int8_T>(rtb_dashes_h);
    ...
    FcuComputer_MATLABFunction(FcuComputer_U.in.discrete_inputs.afs_inputs.spd_mach_button_pressed,
      FcuComputer_U.in.time.dt, &rtb_dashes_h, FcuComputer_P.MTrigNode3_isRisingEdge,
    ...
    if (rtb_DataTypeConversion_e || rtb_OR_o || (rtb_Switch1_oa != 0U)) {
      FcuComputer_DWork.p_trk_fpa_active = false;
    } else if (rtb_OR3_j) {
    ...
    rtb_BusAssignment_m.logic.afs.spd_mach_switching_pushed = rtb_dashes_h;
    ...
    FcuComputer_MATLABFunction_m(rtb_Switch_k_0, &rtb_dashes_h);
    rtb_BusAssignment_m.logic.afs.auto_speed_control = ((rtb_Switch1_oa != 0U) && rtb_dashes_h);
    FcuComputer_MATLABFunction_a(rtb_Switch_k_0, FcuComputer_P.BitfromLabel1_bit_e, &rtb_Switch1_oa);
    rtb_OR_o = ((rtb_dashes_h && (rtb_Switch1_oa != 0U)) || (rtb_Switch_k_0->SSM == static_cast<uint32_T>
    ...
    FcuComputer_MATLABFunction_m(rtb_Switch1_b_0, &rtb_dashes_h);
    rtb_OR3_j = ((rtb_DataTypeConversion_e || (rtb_Switch1_oa != 0U)) && rtb_dashes_h);
    if (rtb_fmgc1Priority) {
    ...
    FcuComputer_MATLABFunction_m(rtb_Switch2_e_0, &rtb_y_o);
    rtb_Equal9 = ((rtb_qfe || rtb_DataTypeConversion_e || rtb_qnh || rtb_Equal9 || rtb_Equal8 || (rtb_Switch1_oa != 0U))
                  && rtb_y_o);
    ...
    rtb_BusAssignment_jg_logic_afs_hdg_trk_selected = (rtb_y_o && (rtb_Equal8 || (rtb_Switch1_oa != 0U)));
    FcuComputer_MATLABFunction_m(rtb_Switch1_b_0, &rtb_dashes_h);
    FcuComputer_MATLABFunction_a(rtb_Switch1_b_0, FcuComputer_P.BitfromLabel2_bit_l, &rtb_Switch1_oa);
    rtb_BusAssignment_jg_logic_afs_hdg_trk_preset_available = (rtb_dashes_h && (rtb_Switch1_oa != 0U));
    ...
    FcuComputer_MATLABFunction_m(rtb_Switch1_b_0, &rtb_y_o);
    rtb_AND2_m = ((rtb_qnh || rtb_qfe || rtb_DataTypeConversion_e || (rtb_Switch1_oa != 0U)) && rtb_y_o);
    if (rtb_fmgc1Priority) {
    ...
    rtb_dashes_h = (rtb_dashes_h && (rtb_Switch1_oa != 0U));
    ...
    rtb_Equal8 = (rtb_Equal6 || (rtb_Switch1_oa != 0U));
    ...
    rtb_y_o = ((!rtb_Equal6) && (!rtb_qnh) && (rtb_Switch1_oa == 0U));
    ...
    rtb_qnh = (rtb_dashes_h || (rtb_Equal8 && rtb_y_o) || rtb_Equal6 || rtb_qnh || rtb_qfe || rtb_DataTypeConversion_e ||
               (rtb_Switch1_oa != 0U));
    ...
    rtb_OR_c = (rtb_Equal6 || (rtb_Switch1_oa != 0U));
    if (rtb_fmgc1Priority) {
    ...
    FcuComputer_MATLABFunction_m(rtb_Switch_k_0, &rtb_dashes_h);
    rtb_BusAssignment_m.logic.afs.exped_active = ((rtb_Switch1_oa != 0U) && rtb_dashes_h);
    if (rtb_fmgc1Priority) {
    ...
    rtb_DataTypeConversion_e = (rtb_Equal6 || rtb_y_o || (rtb_Switch1_oa != 0U));
    FcuComputer_MATLABFunction_m(rtb_Switch_k_0, &rtb_y_o);
    if (rtb_fmgc1Priority) {
    ...
    rtb_Equal6 = (rtb_Equal8 && rtb_Equal6 && rtb_y_o);
    rtb_BusAssignment_m.logic.afs.loc_only_active = (rtb_dashes_h && rtb_DataTypeConversion_e && rtb_y_o && (!rtb_Equal6));
    ...
    FcuComputer_MATLABFunction_m(rtb_Switch_k_0, &rtb_dashes_h);
    rtb_BusAssignment_m.logic.afs.appr_active = (rtb_Equal6 || (rtb_y_o && (rtb_Equal8 || (rtb_Switch1_oa != 0U)) &&
      rtb_dashes_h));
    FcuComputer_MATLABFunction_d(rtb_OR_o, FcuComputer_P.PulseNode_isRisingEdge_l, &rtb_y_o,
    ...
    } else if (rtb_OR_o || (FcuComputer_U.in.discrete_inputs.afs_inputs.spd_knob.turns !=
                            FcuComputer_P.CompareToConstant_const_p0) || (FcuComputer_U.in.sim_input.spd_mach !=
                FcuComputer_P.CompareToConstant1_const)) {
      FcuComputer_DWork.eventTime = FcuComputer_U.in.time.simulation_time;
    }
    ...
    FcuComputer_MATLABFunction_i(rtb_Switch_k_0, FcuComputer_P.A429ValueOrDefault_defaultValue_d, &rtb_y_l2);
    FcuComputer_MATLABFunction_i(rtb_Switch1_b_0, FcuComputer_P.A429ValueOrDefault1_defaultValue_n, &rtb_y_kl);
    ...
    if (rtb_Switch1_oa != 0U) {
      ...
      rtb_y_kl = FcuComputer_P.Constant_Value;
    }

    if (!FcuComputer_DWork.pValue_not_empty_l) {
      if (rtb_BusAssignment_jg_logic_afs_mach_active) {
        FcuComputer_DWork.pValue_p = rtb_y_k;
        FcuComputer_DWork.pValue_not_empty_l = true;
      } else {
        FcuComputer_DWork.pValue_p = rtb_y;
        FcuComputer_DWork.pValue_not_empty_l = true;
      }
    }
    ...
    if (FcuComputer_U.in.sim_input.spd_mach != -1.0F) {
      if (rtb_BusAssignment_jg_logic_afs_mach_active) {
        FcuComputer_DWork.pValue_p = FcuComputer_U.in.sim_input.spd_mach / 100.0F;
      } else {
        FcuComputer_DWork.pValue_p = FcuComputer_U.in.sim_input.spd_mach;
      }
    }
    ...
    if (rtb_y_kl > 0.0F) {
      FcuComputer_DWork.pValue_p = rtb_y_kl;
    }

    if (rtb_BusAssignment_jg_logic_afs_mach_active) {
      FcuComputer_DWork.pValue_p += static_cast<real32_T>(FcuComputer_U.in.discrete_inputs.afs_inputs.spd_knob.turns) *
        0.01F;
      FcuComputer_DWork.pValue_p = std::fmax(std::fmin(FcuComputer_DWork.pValue_p, 0.99F), 0.1F);
      FcuComputer_DWork.pValue_p = std::round(FcuComputer_DWork.pValue_p / 0.01F) * 0.01F;
    } else {
      FcuComputer_DWork.pValue_p += static_cast<real32_T>(FcuComputer_U.in.discrete_inputs.afs_inputs.spd_knob.turns);
      FcuComputer_DWork.pValue_p = std::fmax(std::fmin(FcuComputer_DWork.pValue_p, 399.0F), 100.0F);
      FcuComputer_DWork.pValue_p = std::round(FcuComputer_DWork.pValue_p);
    }
    ...
    rtb_BusAssignment_m.logic.afs.chosen_fmgc_data.v_mach = rtb_y_k;
    rtb_BusAssignment_m.logic.afs.chosen_fmgc_data.hdg_deg = rtb_y_g;
    rtb_BusAssignment_m.logic.afs.chosen_fmgc_data.trk_deg = rtb_y_pk;
    ...
    rtb_BusAssignment_m.logic.afs.selected_speed_control = rtb_OR_o;
    ...
    rtb_BusAssignment_m.logic.afs.lvl_ch_vs_fpa = (rtb_qfe && rtb_OR_c);
    ...
    rtb_BusAssignment_m.logic.afs.spd_mach_display_value = FcuComputer_DWork.pValue_p;
    ...
    FcuComputer_MATLABFunction_d((rtb_Equal6 && rtb_BusAssignment_j_logic_afs_any_ap_fd_engaged),
      FcuComputer_P.PulseNode1_isRisingEdge_d, &rtb_dashes_h, &FcuComputer_DWork.sf_MATLABFunction_du);
    FcuComputer_MATLABFunction_d((rtb_Equal6 && (!rtb_BusAssignment_jg_logic_afs_hdg_trk_preset_available) &&
      rtb_BusAssignment_j_logic_afs_any_ap_fd_engaged), FcuComputer_P.PulseNode_isRisingEdge_h, &rtb_y_o,
      &FcuComputer_DWork.sf_MATLABFunction_dc);
    rtb_OR3_j = !rtb_BusAssignment_j_logic_afs_any_ap_fd_engaged;
    FcuComputer_MATLABFunction1(&rtb_BusAssignment_m, (rtb_dashes_h || rtb_y_o),
      (rtb_BusAssignment_jg_logic_afs_hdg_trk_selected || rtb_OR3_j ||
       ...
       rtb_BusAssignment_jg_logic_afs_hdg_trk_preset_available), &rtb_dashes_h, &FcuComputer_DWork.sf_MATLABFunction1);
    if (!FcuComputer_DWork.pValue_not_empty_p) {
      if (FcuComputer_DWork.p_trk_fpa_active) {
        FcuComputer_DWork.pValue_m = rtb_y_pk;
        FcuComputer_DWork.pValue_not_empty_p = true;
      } else {
        FcuComputer_DWork.pValue_m = rtb_y_g;
        FcuComputer_DWork.pValue_not_empty_p = true;
      }
    }
    ...
    if (FcuComputer_U.in.sim_input.hdg_trk != -1.0F) {
      FcuComputer_DWork.pValue_m = FcuComputer_U.in.sim_input.hdg_trk;
    }

    if (FcuComputer_DWork.prevTrkFpaActive_m != FcuComputer_DWork.p_trk_fpa_active) {
      if (FcuComputer_DWork.p_trk_fpa_active) {
        rtb_y = FcuComputer_DWork.pValue_m - rtb_y_g;
      } else {
        rtb_y = FcuComputer_DWork.pValue_m - rtb_y_pk;
      }
    ...
    if (rtb_dashes_h) {
      if (FcuComputer_DWork.p_trk_fpa_active) {
        FcuComputer_DWork.pValue_m = rtb_y_pk;
        FcuComputer_DWork.pValue_m = std::round(FcuComputer_DWork.pValue_m);
      } else {
        FcuComputer_DWork.pValue_m = rtb_y_g;
        FcuComputer_DWork.pValue_m = std::round(FcuComputer_DWork.pValue_m);
      }
    ...
    FcuComputer_DWork.pValue_m += static_cast<real32_T>(FcuComputer_U.in.discrete_inputs.afs_inputs.hdg_trk_knob.turns);
    FcuComputer_DWork.pValue_m = std::round(FcuComputer_DWork.pValue_m);
    if (FcuComputer_DWork.pValue_m > 359.0F) {
      FcuComputer_DWork.pValue_m -= 360.0F;
    } else if (FcuComputer_DWork.pValue_m < 0.0F) {
      FcuComputer_DWork.pValue_m += 360.0F;
    }

    FcuComputer_DWork.prevTrkFpaActive_m = FcuComputer_DWork.p_trk_fpa_active;
    rtb_BusAssignment_m.logic.afs.hdg_trk_display_value = FcuComputer_DWork.pValue_m;
    rtb_BusAssignment_m.logic.afs.hdg_trk_dashes = rtb_dashes_h;
    y = FcuComputer_U.in.discrete_inputs.afs_inputs.alt_increment_1000 * 900;
    increment = FcuComputer_U.in.discrete_inputs.afs_inputs.alt_increment_1000 * 900 + 100;
    if (!FcuComputer_DWork.pValue_not_empty_j) {
      FcuComputer_DWork.pValue_e = std::round(rtb_BusAssignment_m.logic.afs.chosen_fmgc_data.alt_ft /
        static_cast<real32_T>(increment)) * (static_cast<real32_T>(y) + 100.0F);
      FcuComputer_DWork.pValue_not_empty_j = true;
    }

    if (FcuComputer_U.in.sim_input.alt != -1.0F) {
      FcuComputer_DWork.pValue_e = FcuComputer_U.in.sim_input.alt;
    }

    if ((FcuComputer_U.in.sim_input.alt != -1.0F) || (FcuComputer_U.in.discrete_inputs.afs_inputs.alt_knob.turns != 0))
    {
      FcuComputer_DWork.pValue_e = std::round(((static_cast<real32_T>(increment) / 2.0F + 1.0F) * static_cast<real32_T>
        (FcuComputer_U.in.discrete_inputs.afs_inputs.alt_knob.turns) + FcuComputer_DWork.pValue_e) /
        static_cast<real32_T>(increment)) * (static_cast<real32_T>(y) + 100.0F);
    }

    FcuComputer_DWork.pValue_e = std::fmax(std::fmin(FcuComputer_DWork.pValue_e, 49000.0F), 100.0F);
    rtb_BusAssignment_m.logic.afs.alt_display_value = FcuComputer_DWork.pValue_e;
    ...
    rtb_y_o = (FcuComputer_U.in.sim_input.vs_fpa != FcuComputer_P.CompareToConstant1_const_j);
    FcuComputer_MATLABFunction1(&rtb_BusAssignment_m, rtb_Equal8, (rtb_BusAssignment_m.logic.afs.lvl_ch_vs_fpa ||
      rtb_OR3_j || rtb_Equal6 || rtb_y_o), &rtb_Equal9, &FcuComputer_DWork.sf_MATLABFunction1_o);
    ...
    FcuComputer_MATLABFunction_d((FcuComputer_U.in.discrete_inputs.ap_1_engaged ||
      FcuComputer_U.in.discrete_inputs.ap_2_engaged), FcuComputer_P.PulseNode_isRisingEdge_d, &rtb_y_o,
    ...
    if (rtb_Equal6) {
      ...
      rtb_y_g = FcuComputer_DWork.pValue_e - rtb_BusAssignment_m.logic.afs.chosen_fmgc_data.alt_ft;
      if ((rtb_BusAssignment_m.logic.afs.chosen_fmgc_data.alt_ft > 30000.0F) && (rtb_y_g > 0.0F)) {
        ...
        FcuComputer_DWork.pValue = 1000.0F * static_cast<real32_T>(y);
      }
    }
    ...
    FcuComputer_DWork.prevTrkFpaActive = FcuComputer_DWork.p_trk_fpa_active;
    FcuComputer_MATLABFunction((FcuComputer_DWork.pValue_m != FcuComputer_DWork.DelayInput1_DSTATE[0]),
    ...
    FcuComputer_MATLABFunction((FcuComputer_DWork.pValue_e != FcuComputer_DWork.DelayInput1_DSTATE[1]),
      FcuComputer_U.in.time.dt, &rtb_y_o, FcuComputer_P.MTrigNode1_isRisingEdge_m,
    ...
    FcuComputer_MATLABFunction((FcuComputer_DWork.pValue_p != FcuComputer_DWork.DelayInput1_DSTATE[3]),
    ...
    rtb_BusAssignment_n_logic_afs_alt_value_changed = rtb_y_o;
    ...
    FcuComputer_MATLABFunction_d(FcuComputer_U.in.discrete_inputs.capt_efis_inputs.vord_button_pushed,
      FcuComputer_P.PulseNode2_isRisingEdge_m, &rtb_y_o, &FcuComputer_DWork.sf_MATLABFunction_ome);
    ...
    FcuComputer_EFISFilterLogic(rtb_Equal9, rtb_Equal8, rtb_y_o, rtb_Equal6, rtb_OR3_j, &rtb_BusAssignment_d_efis_filter,
    ...
    FcuComputer_MATLABFunction_ml(FcuComputer_U.in.discrete_inputs.capt_efis_inputs.fd_button_pushed,
      ...
      &rtb_y_o, &FcuComputer_DWork.sf_MATLABFunction_ml);
    ...
    FcuComputer_MATLABFunction_o(rtb_Equal8, rtb_OR3_j, FcuComputer_U.in.discrete_inputs.pin_prog_qfe_avail, &rtb_Equal9,
      &rtb_BusAssignment_d_baro_qnh, &rtb_qfe, &FcuComputer_DWork.sf_MATLABFunction_ofc);
    FcuComputer_MATLABFunction1_o(rtb_Equal9, FcuComputer_U.in.discrete_inputs.capt_efis_inputs.baro_is_inhg,
      ...
      FcuComputer_U.in.sim_input.left_baro_setting_hpa, &rtb_y_l2, &rtb_y_pk, &FcuComputer_DWork.sf_MATLABFunction1_ou);
    rtb_BusAssignment_d_fd_on = rtb_y_o;
    ...
    FcuComputer_MATLABFunction_d(FcuComputer_U.in.discrete_inputs.fo_efis_inputs.vord_button_pushed,
      FcuComputer_P.PulseNode2_isRisingEdge_i, &rtb_y_o, &FcuComputer_DWork.sf_MATLABFunction_am);
    ...
    FcuComputer_EFISFilterLogic(rtb_Equal9, rtb_Equal8, rtb_y_o, rtb_Equal6, rtb_OR3_j, &rtb_efisFilter,
    ...
    FcuComputer_MATLABFunction_ml(FcuComputer_U.in.discrete_inputs.fo_efis_inputs.fd_button_pushed,
      rtb_BusAssignment_n_logic_capt_efis_fd_auto_activate, rtb_BusAssignment_n_logic_capt_efis_fd_auto_deactivate,
      &rtb_y_o, &FcuComputer_DWork.sf_MATLABFunction_bx);
    ...
    FcuComputer_MATLABFunction1_o(rtb_Equal9, FcuComputer_U.in.discrete_inputs.fo_efis_inputs.baro_is_inhg, static_cast<
      ...
      FcuComputer_U.in.sim_input.right_baro_setting_hpa, &rtb_BusAssignment_b_logic_fo_efis.baro_value_hpa, &rtb_y_pk,
    ...
    rtb_BusAssignment_b_logic_capt_efis.baro_qnh = rtb_BusAssignment_d_baro_qnh;
    rtb_BusAssignment_b_logic_capt_efis.baro_value_hpa = rtb_y_l2;
    rtb_BusAssignment_b_logic_capt_efis.baro_value_inhg = rtb_y_kl;
    rtb_BusAssignment_b_logic_fo_efis.fd_on = rtb_y_o;
    ...
    rtb_BusAssignment_b_logic_fo_efis.baro_value_inhg = rtb_y_pk;
    ...
    rtb_VectorConcatenate[18] = rtb_BusAssignment_d_baro_qnh;
    ...
    rtb_VectorConcatenate[4] = rtb_OR_c;
    ...
    FcuComputer_MATLABFunction_e(rtb_VectorConcatenate, &rtb_y_pk);
    if (rtb_fmgc1Priority) {
    ...
    FcuComputer_Y.out.logic.afs.selected_speed_control = rtb_OR_o;
    FcuComputer_Y.out.logic.afs.spd_mach_display_value = FcuComputer_DWork.pValue_p;
    ...
    FcuComputer_Y.out.logic.afs.hdg_trk_display_value = FcuComputer_DWork.pValue_m;
    FcuComputer_Y.out.logic.afs.hdg_trk_dashes = rtb_dashes_h;
    FcuComputer_Y.out.logic.afs.hdg_trk_preset_available = rtb_BusAssignment_jg_logic_afs_hdg_trk_preset_available;
    FcuComputer_Y.out.logic.afs.alt_display_value = FcuComputer_DWork.pValue_e;
    ...
    FcuComputer_Y.out.logic.afs.spd_mach_value_changed = rtb_OR_c;
    ...
    FcuComputer_Y.out.discrete_outputs.fo_efis_outputs.fd_light_on = rtb_y_o;
    ...
    FcuComputer_Y.out.discrete_outputs.afs_outputs.spd_mach_value = FcuComputer_DWork.pValue_p;
    ...
    FcuComputer_Y.out.discrete_outputs.afs_outputs.hdg_trk_value = FcuComputer_DWork.pValue_m;
    FcuComputer_Y.out.discrete_outputs.afs_outputs.hdg_trk_dashes = rtb_dashes_h;
    FcuComputer_Y.out.discrete_outputs.afs_outputs.hdg_trk_managed = rtb_BusAssignment_m.logic.afs.hdg_trk_managed;
    FcuComputer_Y.out.discrete_outputs.afs_outputs.alt_value = FcuComputer_DWork.pValue_e;
    ...
    if (rtb_dashes_h || FcuComputer_DWork.p_trk_fpa_active) {
    ...
    FcuComputer_Y.out.bus_outputs.selected_hdg_deg.Data = FcuComputer_DWork.pValue_m;
    FcuComputer_Y.out.bus_outputs.selected_alt_ft.SSM = static_cast<uint32_T>(FcuComputer_P.EnumeratedConstant1_Value);
    FcuComputer_Y.out.bus_outputs.selected_alt_ft.Data = FcuComputer_DWork.pValue_e;
    ...
    if (rtb_BusAssignment_jg_logic_afs_mach_active) {
      ...
      FcuComputer_Y.out.bus_outputs.selected_spd_kts.Data = FcuComputer_DWork.pValue_p;
    }
    ...
    if (rtb_BusAssignment_jg_logic_afs_mach_active) {
      FcuComputer_Y.out.bus_outputs.selected_mach.Data = FcuComputer_DWork.pValue_p;
    } else {
    ...
    FcuComputer_Y.out.bus_outputs.selected_trk_deg.Data = FcuComputer_DWork.pValue_m;
    if (rtb_BusAssignment_n_logic_afs_vs_fpa_dashes || (!FcuComputer_DWork.p_trk_fpa_active)) {
    ...
    FcuComputer_Y.out.bus_outputs.eis_discrete_word_1_left.SSM = static_cast<uint32_T>
      (FcuComputer_P.EnumeratedConstant1_Value);
    FcuComputer_Y.out.bus_outputs.eis_discrete_word_1_left.Data = rtb_y_g;
    FcuComputer_Y.out.bus_outputs.eis_discrete_word_1_right.SSM = static_cast<uint32_T>
      (FcuComputer_P.EnumeratedConstant1_Value);
    FcuComputer_Y.out.bus_outputs.eis_discrete_word_1_right.Data = rtb_y_k;
    ...
    FcuComputer_Y.out.bus_outputs.baro_setting_left_hpa.SSM = static_cast<uint32_T>
      (FcuComputer_P.EnumeratedConstant1_Value);
    FcuComputer_Y.out.bus_outputs.baro_setting_left_hpa.Data = rtb_y_l2;
    ...
    FcuComputer_Y.out.bus_outputs.baro_setting_left_inhg.SSM = static_cast<uint32_T>
      (FcuComputer_P.EnumeratedConstant1_Value);
    FcuComputer_Y.out.bus_outputs.baro_setting_left_inhg.Data = rtb_y_kl;
    ...
    FcuComputer_Y.out.bus_outputs.fcu_discrete_word_1.SSM = static_cast<uint32_T>
      (FcuComputer_P.EnumeratedConstant1_Value);
    FcuComputer_Y.out.bus_outputs.fcu_discrete_word_1.Data = rtb_y_pk;
    FcuComputer_DWork.DelayInput1_DSTATE[0] = FcuComputer_DWork.pValue_m;
    FcuComputer_DWork.DelayInput1_DSTATE[1] = FcuComputer_DWork.pValue_e;
    FcuComputer_DWork.DelayInput1_DSTATE[2] = FcuComputer_DWork.pValue;
    FcuComputer_DWork.DelayInput1_DSTATE[3] = FcuComputer_DWork.pValue_p;
  } else {
