...
#ifndef FLYBYWIRE_AIRCRAFT_AIRCRAFTPRESETPROCEDURES_A333X_H
#define FLYBYWIRE_AIRCRAFT_AIRCRAFTPRESETPROCEDURES_A333X_H

#include "AircraftPresets/PresetProceduresDefinition.h"
#include "AircraftPresets/ProcedureStep.h"

/**
 * A333X specific aircraft procedures definition.
 *
 * @see AircraftProceduresDefinition
 */
class AircraftPresetProcedures_A333X {
 public:
...
#endif  // FLYBYWIRE_AIRCRAFT_AIRCRAFTPRESETPROCEDURES_A333X_H
