...
COMMON_DIR="${DIR}/../../../../build-a333x-common/src/wasm"
OUTPUT="${DIR}/../../../../build-a333x/out/headwindsim-aircraft-a330-300/SimObjects/Airplanes/Headwind_A330_300/panel/flypad-backend.wasm"
