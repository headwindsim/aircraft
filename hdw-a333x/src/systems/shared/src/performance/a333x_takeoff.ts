 ...
 */
export class A330343TakeoffPerformanceCalculator implements TakeoffPerformanceCalculator {
  ...
  public calculateTakeoffPerformance(
    ...
    result.params = {
      adjustedTora: tora - (A330343TakeoffPerformanceCalculator.lineUpDistances[lineupAngle] ?? 0),
      pressureAlt,
      isaTemp,
      tRef,
      tMax,
    ...
    if (result.error === TakeoffPerfomanceError.None) {
      ...
      if (runwayCondition === RunwayCondition.Dry) {
        ...
        const factors: ReadonlyFloat64Array = (
          result.inputs.oat > result.tvmcg
            ? A330343TakeoffPerformanceCalculator.wetTowAdjustmentFactorsAboveTvmcg
            : A330343TakeoffPerformanceCalculator.wetTowAdjustmentFactorsAtOrBelowTvmcg
        )[result.inputs.conf].get(A330343TakeoffPerformanceCalculator.vec4Cache, result.params.headwind);
        ...
        switch (runwayCondition) {
          case RunwayCondition.Contaminated6mmWater:
            correctionFactors = A330343TakeoffPerformanceCalculator.weightCorrectionContaminated6mmWater;
            mtowFactors = A330343TakeoffPerformanceCalculator.mtowContaminated6mmWater;
            minCorrectedWeight = A330343TakeoffPerformanceCalculator.minCorrectedTowContaminated6mmWater;
            break;
          case RunwayCondition.Contaminated13mmWater:
            correctionFactors = A330343TakeoffPerformanceCalculator.weightCorrectionContaminated13mmWater;
            mtowFactors = A330343TakeoffPerformanceCalculator.mtowContaminated13mmWater;
            minCorrectedWeight = A330343TakeoffPerformanceCalculator.minCorrectedTowContaminated13mmWater;
            break;
          case RunwayCondition.Contaminated6mmSlush:
            correctionFactors = A330343TakeoffPerformanceCalculator.weightCorrectionContaminated6mmSlush;
            mtowFactors = A330343TakeoffPerformanceCalculator.mtowContaminated6mmSlush;
            minCorrectedWeight = A330343TakeoffPerformanceCalculator.minCorrectedTowContaminated6mmSlush;
            break;
          case RunwayCondition.Contaminated13mmSlush:
            correctionFactors = A330343TakeoffPerformanceCalculator.weightCorrectionContaminated13mmSlush;
            mtowFactors = A330343TakeoffPerformanceCalculator.mtowContaminated13mmSlush;
            minCorrectedWeight = A330343TakeoffPerformanceCalculator.minCorrectedTowContaminated13mmSlush;
            break;
          case RunwayCondition.ContaminatedCompactedSnow:
            correctionFactors = A330343TakeoffPerformanceCalculator.weightCorrectionContaminatedCompactedSnow;
            mtowFactors = A330343TakeoffPerformanceCalculator.mtowContaminatedCompactedSnow;
            minCorrectedWeight = A330343TakeoffPerformanceCalculator.minCorrectedTowContaminatedCompactedSnow;
            break;
          case RunwayCondition.Contaminated5mmWetSnow:
            correctionFactors = A330343TakeoffPerformanceCalculator.weightCorrectionContaminated5mmWetSnow;
            mtowFactors = A330343TakeoffPerformanceCalculator.mtowContaminated5mmWetSnow;
            minCorrectedWeight = A330343TakeoffPerformanceCalculator.minCorrectedTowContaminated5mmWetSnow;
            break;
          case RunwayCondition.Contaminated15mmWetSnow:
            correctionFactors = A330343TakeoffPerformanceCalculator.weightCorrectionContaminated15mmWetSnow;
            mtowFactors = A330343TakeoffPerformanceCalculator.mtowContaminated15mmWetSnow;
            minCorrectedWeight = A330343TakeoffPerformanceCalculator.minCorrectedTowContaminated15mmWetSnow;
            break;
          case RunwayCondition.Contaminated30mmWetSnow:
            correctionFactors = A330343TakeoffPerformanceCalculator.weightCorrectionContaminated30mmWetSnow;
            mtowFactors = A330343TakeoffPerformanceCalculator.mtowContaminated30mmWetSnow;
            minCorrectedWeight = A330343TakeoffPerformanceCalculator.minCorrectedTowContaminated30mmWetSnow;
            break;
          case RunwayCondition.Contaminated10mmDrySnow:
            correctionFactors = A330343TakeoffPerformanceCalculator.weightCorrectionContaminated10mmDrySnow;
            mtowFactors = A330343TakeoffPerformanceCalculator.mtowContaminated10mmDrySnow;
            minCorrectedWeight = A330343TakeoffPerformanceCalculator.minCorrectedTowContaminated10mmDrySnow;
            break;
          case RunwayCondition.Contaminated100mmDrySnow:
            correctionFactors = A330343TakeoffPerformanceCalculator.weightCorrectionContaminated100mmDrySnow;
            mtowFactors = A330343TakeoffPerformanceCalculator.mtowContaminated100mmDrySnow;
            minCorrectedWeight = A330343TakeoffPerformanceCalculator.minCorrectedTowContaminated100mmDrySnow;
            break;
          default:
      ...
      if (applyForwardCgWeightCorrection) {
        const cgFactors = A330343TakeoffPerformanceCalculator.cgFactors[conf];
      ...
      if (mtow >= tow) {
        ...
        if (forceToga) {
          ...
          const tailwindResult = this.calculateTakeoffPerformance(
            ...
            runwayCondition,
            cg,
            A330343TakeoffPerformanceCalculator.resultCache,
          );
        ...
        if (result.inputs.runwayCondition === RunwayCondition.Wet) {
          ...
          const factors: ReadonlyFloat64Array = (
            result.inputs.oat > tvmcg
              ? A330343TakeoffPerformanceCalculator.wetFlexAdjustmentFactorsAboveTvmcg
              : A330343TakeoffPerformanceCalculator.wetFlexAdjustmentFactorsAtOrBelowTvmcg
          )[result.inputs.conf].get(A330343TakeoffPerformanceCalculator.vec4Cache, result.params.headwind);
  ...
  private calculateVSpeeds(
    ...
    if (result.inputs.runwayCondition == RunwayCondition.Dry || result.inputs.runwayCondition === RunwayCondition.Wet) {
      ...
      if (result.inputs.runwayCondition === RunwayCondition.Dry) {
        ...
        const v1Factors: ReadonlyFloat64Array = (
          result.inputs.oat > tvmcg
            ? A330343TakeoffPerformanceCalculator.wetV1AdjustmentFactorsAboveTvmcg
            : A330343TakeoffPerformanceCalculator.wetV1AdjustmentFactorsAtOrBelowTvmcg
        )[result.inputs.conf].get(A330343TakeoffPerformanceCalculator.vec4Cache, result.params.headwind);
        const vRFactors: ReadonlyFloat64Array | undefined = (
          result.inputs.oat > tvmcg
            ? undefined
            : A330343TakeoffPerformanceCalculator.wetVRAdjustmentFactorsAtOrBelowTvmcg
        )?.[result.inputs.conf].get(A330343TakeoffPerformanceCalculator.vec4Cache, result.params.headwind);
        const v2Factors: ReadonlyFloat64Array | undefined = (
          result.inputs.oat > tvmcg
            ? undefined
            : A330343TakeoffPerformanceCalculator.wetV2AdjustmentFactorsAtOrBelowTvmcg
        )?.[result.inputs.conf].get(A330343TakeoffPerformanceCalculator.vec4Cache, result.params.headwind);
    ...
    switch (result.inputs.runwayCondition) {
      case RunwayCondition.Contaminated6mmWater:
        contamVSpeeds = A330343TakeoffPerformanceCalculator.vSpeedsContaminated6mmWater;
        break;
      case RunwayCondition.Contaminated13mmWater:
        contamVSpeeds = A330343TakeoffPerformanceCalculator.vSpeedsContaminated13mmWater;
        break;
      case RunwayCondition.Contaminated6mmSlush:
        contamVSpeeds = A330343TakeoffPerformanceCalculator.vSpeedsContaminated6mmSlush;
        break;
      case RunwayCondition.Contaminated13mmSlush:
        contamVSpeeds = A330343TakeoffPerformanceCalculator.vSpeedsContaminated13mmSlush;
        break;
      case RunwayCondition.ContaminatedCompactedSnow:
        contamVSpeeds = A330343TakeoffPerformanceCalculator.vSpeedsContaminatedCompactedSnow;
        break;
      case RunwayCondition.Contaminated5mmWetSnow:
        contamVSpeeds = A330343TakeoffPerformanceCalculator.vSpeedsContaminated5mmWetSnow;
        break;
      case RunwayCondition.Contaminated15mmWetSnow:
        contamVSpeeds = A330343TakeoffPerformanceCalculator.vSpeedsContaminated15mmWetSnow;
        break;
      case RunwayCondition.Contaminated10mmDrySnow:
        contamVSpeeds = A330343TakeoffPerformanceCalculator.vSpeedsContaminated10mmDrySnow;
        break;
      case RunwayCondition.Contaminated100mmDrySnow:
        contamVSpeeds = A330343TakeoffPerformanceCalculator.vSpeedsContaminated100mmDrySnow;
        break;
      default:
        throw new Error('Invalid runway condition');
    }
    ...
    const [v1, vR, v2] = contamVSpeeds[result.inputs.conf].get(
      A330343TakeoffPerformanceCalculator.vec3Cache,
      result.inputs.tow,
    );
  ...
  private calculateDryVSpeeds(result: Partial<TakeoffPerformanceResult>, applyForwardCgSpeedCorrection: boolean): void {
    ...
    if (limitingFactor === LimitingFactor.Runway || limitingFactor === LimitingFactor.Vmcg) {
      ...
      const [v2BaseFactor1, v2BaseFactor2]: [number, number] =
        A330343TakeoffPerformanceCalculator.v2RunwayVmcgBaseFactors[result.inputs.conf];
      speeds.v2Base = (result.inputs.tow / 1000) * v2BaseFactor1 + v2BaseFactor2;

      const [v2AltFactor1, v2AltFactor2] =
        A330343TakeoffPerformanceCalculator.v2RunwayVmcgAltFactors[result.inputs.conf];
      ...
      const [vRBaseFactor1, vRBaseFactor2]: [number, number] =
        A330343TakeoffPerformanceCalculator.vRRunwayVmcgBaseFactors[result.inputs.conf];
      speeds.vRBase = (result.inputs.tow / 1000) * vRBaseFactor1 + vRBaseFactor2;

      const [vRBaseLength, vRRunwayFactor1, vRRunwayFactor2] =
        A330343TakeoffPerformanceCalculator.vRRunwayVmcgRunwayFactors[result.inputs.conf];
      ...
      const [vRFactorAlt1, vRFactorAlt2] =
        A330343TakeoffPerformanceCalculator.vRRunwayVmcgAltFactors[result.inputs.conf];
      speeds.vRDeltaAlt = result.params.pressureAlt * ((result.inputs.tow / 1000) * vRFactorAlt1 + vRFactorAlt2);

      const vRFactorSlope = A330343TakeoffPerformanceCalculator.vRRunwayVmcgSlopeFactors[result.inputs.conf];
      ...
      const [vRWindFactor1, vRWindFactor2] =
        result.params.headwind >= 0
          ? A330343TakeoffPerformanceCalculator.vRRunwayVmcgHeadwindFactors[result.inputs.conf]
          : A330343TakeoffPerformanceCalculator.vRRunwayVmcgTailwindFactors[result.inputs.conf];
      ...
      const [v1BaseFactor1, v1BaseFactor2]: [number, number] =
        A330343TakeoffPerformanceCalculator.v1RunwayVmcgBaseFactors[result.inputs.conf];
      speeds.v1Base = (result.inputs.tow / 1000) * v1BaseFactor1 + v1BaseFactor2;

      const [v1BaseLength, v1RunwayFactor1, v1RunwayFactor2] =
        A330343TakeoffPerformanceCalculator.v1RunwayVmcgRunwayFactors[result.inputs.conf];
      ...
      const [v1FactorAlt1, v1FactorAlt2] =
        A330343TakeoffPerformanceCalculator.v1RunwayVmcgAltFactors[result.inputs.conf];
      speeds.v1DeltaAlt = result.params.pressureAlt * ((result.inputs.tow / 1000) * v1FactorAlt1 + v1FactorAlt2);

      const v1FactorSlope = A330343TakeoffPerformanceCalculator.v1RunwayVmcgSlopeFactors[result.inputs.conf];
      speeds.v1DeltaSlope = result.inputs.slope * result.params.adjustedTora * v1FactorSlope;

      const [v1WindFactor1, v1WindFactor2] =
        result.params.headwind >= 0
          ? A330343TakeoffPerformanceCalculator.v1RunwayVmcgHeadwindFactors[result.inputs.conf]
          : A330343TakeoffPerformanceCalculator.v1RunwayVmcgTailwindFactors[result.inputs.conf];
      ...
      const [v2ThresholdFactor1, v2ThresholdFactor2] =
        A330343TakeoffPerformanceCalculator.v2SecondSegBrakeThresholds[result.inputs.conf];
      ...
      const [vRBaseFactor1, vRBaseFactor2]: [number, number] = useTable2
        ? A330343TakeoffPerformanceCalculator.vRSecondSegBrakeBaseTable2[result.inputs.conf]
        : A330343TakeoffPerformanceCalculator.vRSecondSegBrakeBaseTable1[result.inputs.conf];
      speeds.vRBase = (result.inputs.tow / 1000) * vRBaseFactor1 + vRBaseFactor2;

      const [vRBaseLength, vRRunwayFactor1, vRRunwayFactor2] = useTable2
        ? A330343TakeoffPerformanceCalculator.vRSecondSegBrakeRunwayTable2[result.inputs.conf]
        : A330343TakeoffPerformanceCalculator.vRSecondSegBrakeRunwayTable1[result.inputs.conf];
      speeds.vRDeltaRunway =
        (vRBaseLength - result.params.adjustedTora) * ((result.inputs.tow / 1000) * vRRunwayFactor1 + vRRunwayFactor2);

      const [vRAltFactor1, vRAltFactor2, vRAltFactor3, vRAltFactor4] = useTable2
        ? A330343TakeoffPerformanceCalculator.vRSecondSegBrakeAltTable2[result.inputs.conf]
        : A330343TakeoffPerformanceCalculator.vRSecondSegBrakeAltTable1[result.inputs.conf];
      speeds.vRDeltaAlt =
        result.params.pressureAlt *
      ...
      const [vRSlopeFactor1, vRSlopeFactor2] =
        A330343TakeoffPerformanceCalculator.vRSecondSegBrakeSlopeFactors[result.inputs.conf];
      speeds.vRDeltaSlope =
        result.inputs.slope *
        result.params.adjustedTora *
      ...
      const [vRWindFactor1, vRWindFactor2] =
        result.params.headwind >= 0
          ? A330343TakeoffPerformanceCalculator.vRSecondSegBrakeHeadwindFactors[result.inputs.conf]
          : A330343TakeoffPerformanceCalculator.vRSecondSegBrakeTailwindFactors[result.inputs.conf];
      speeds.vRDeltaWind = result.params.headwind * ((result.inputs.tow / 1000) * vRWindFactor1 + vRWindFactor2);
  ...
  private calculateSecondSegBrakeV2(
    ...
    const [v2BaseFactor1, v2BaseFactor2] =
      A330343TakeoffPerformanceCalculator.v2SecondSegBrakeBaseTable1[result.inputs.conf];
    speeds.v2Base = (result.inputs.tow / 1000) * v2BaseFactor1 + v2BaseFactor2;

    if (useTable2) {
      const [v2BaseFactor1, v2BaseFactor2] =
        A330343TakeoffPerformanceCalculator.v2SecondSegBrakeBaseTable2[result.inputs.conf];
      speeds.v2Base = (result.inputs.tow / 1000) * v2BaseFactor1 + v2BaseFactor2;
    }

    const [v2BaseRunwayLength, v2RunwayFactor] = useTable2
      ? A330343TakeoffPerformanceCalculator.v2SecondSegBrakeRunwayTable2[result.inputs.conf]
      : A330343TakeoffPerformanceCalculator.v2SecondSegBrakeRunwayTable1[result.inputs.conf];
    ...
    const [v2AltFactor1, v2AltFactor2, v2AltFactor3, v2AltFactor4] =
      A330343TakeoffPerformanceCalculator.v2SecondSegBrakeAltFactors[result.inputs.conf];
    speeds.v2DeltaAlt =
      result.params.pressureAlt *
    ...
    const [v2SlopeFactor1, v2SlopeFactor2] =
      A330343TakeoffPerformanceCalculator.v2SecondSegBrakeSlopeFactors[result.inputs.conf];
    speeds.v2DeltaSlope =
    ...
    if (correctWind) {
      const v2WindFactor =
        result.params.headwind >= 0
          ? A330343TakeoffPerformanceCalculator.v2SecondSegBrakeHeadwindFactors[result.inputs.conf]
          : A330343TakeoffPerformanceCalculator.v2SecondSegBrakeTailwindFactors[result.inputs.conf];
  ...
  private calculateSecondSegBrakeV1(
    ...
    const [v1BaseFactor1, v1BaseFactor2]: [number, number] = useTable2
      ? A330343TakeoffPerformanceCalculator.v1SecondSegBrakeBaseTable2[result.inputs.conf]
      : A330343TakeoffPerformanceCalculator.v1SecondSegBrakeBaseTable1[result.inputs.conf];
    speeds.v1Base = (result.inputs.tow / 1000) * v1BaseFactor1 + v1BaseFactor2;

    const [v1BaseLength, v1RunwayFactor1, v1RunwayFactor2] = useTable2
      ? A330343TakeoffPerformanceCalculator.v1SecondSegBrakeRunwayTable2[result.inputs.conf]
      : A330343TakeoffPerformanceCalculator.v1SecondSegBrakeRunwayTable1[result.inputs.conf];
    speeds.v1DeltaRunway =
      (v1BaseLength - result.params.adjustedTora) * ((result.inputs.tow / 1000) * v1RunwayFactor1 + v1RunwayFactor2);

    const [v1AltFactor1, v1AltFactor2, v1AltFactor3, v1AltFactor4] = useTable2
      ? A330343TakeoffPerformanceCalculator.v1SecondSegBrakeAltTable2[result.inputs.conf]
      : A330343TakeoffPerformanceCalculator.v1SecondSegBrakeAltTable1[result.inputs.conf];
    speeds.v1DeltaAlt =
      result.params.pressureAlt *
    ...
    const [v1SlopeFactor1, v1SlopeFactor2] =
      A330343TakeoffPerformanceCalculator.v1SecondSegBrakeSlopeFactors[result.inputs.conf];
    speeds.v1DeltaSlope =
      result.inputs.slope * result.params.adjustedTora * ((result.inputs.tow / 1000) * v1SlopeFactor1 + v1SlopeFactor2);

    const [v1WindFactor1, v1WindFactor2] =
      result.params.headwind >= 0
        ? A330343TakeoffPerformanceCalculator.v1SecondSegBrakeHeadwindFactors[result.inputs.conf]
        : A330343TakeoffPerformanceCalculator.v1SecondSegBrakeTailwindFactors[result.inputs.conf];
    speeds.v1DeltaWind = result.params.headwind * ((result.inputs.tow / 1000) * v1WindFactor1 + v1WindFactor2);
  ...
  private reconcileVSpeeds(
    ...
    const minV1Vmc = Math.ceil(A330343TakeoffPerformanceCalculator.minimumV1Vmc.get(result.params.pressureAlt));
    const minVrVmc = Math.ceil(A330343TakeoffPerformanceCalculator.minimumVrVmc.get(result.params.pressureAlt));
    const minV2Vmc = Math.ceil(
      A330343TakeoffPerformanceCalculator.minimumV2Vmc[result.inputs.conf].get(result.params.pressureAlt),
    );
    const minv2Vmu = Math.ceil(
      A330343TakeoffPerformanceCalculator.minimumV2Vmu[result.inputs.conf].get(
        result.params.pressureAlt,
        result.inputs.tow,
      ),
    );
  ...
  private calculateWeightLimits(
    ...
    let baseFactors: typeof A330343TakeoffPerformanceCalculator.secondSegmentBaseFactor | undefined;
    let slopeFactors: typeof A330343TakeoffPerformanceCalculator.runwaySlopeFactor;
    let altFactors: typeof A330343TakeoffPerformanceCalculator.runwayPressureAltFactor;
    ...
    switch (limitingFactor) {
      case LimitingFactor.Runway:
        // no base factors
        slopeFactors = A330343TakeoffPerformanceCalculator.runwaySlopeFactor;
        altFactors = A330343TakeoffPerformanceCalculator.runwayPressureAltFactor;
        tempDeltaFunc = this.calculateRunwayTempDelta;
        windDeltaFunc = this.calculateRunwayWindDelta;
        break;
      case LimitingFactor.SecondSegment:
        baseFactors = A330343TakeoffPerformanceCalculator.secondSegmentBaseFactor;
        slopeFactors = A330343TakeoffPerformanceCalculator.secondSegmentSlopeFactor;
        altFactors = A330343TakeoffPerformanceCalculator.secondSegmentPressureAltFactor;
        tempDeltaFunc = this.calculateSecondSegmentTempDelta;
        windDeltaFunc = this.calculateSecondSegmentWindDelta;
        break;
      case LimitingFactor.BrakeEnergy:
        baseFactors = A330343TakeoffPerformanceCalculator.brakeEnergyBaseFactor;
        slopeFactors = A330343TakeoffPerformanceCalculator.brakeEnergySlopeFactor;
        altFactors = A330343TakeoffPerformanceCalculator.brakeEnergyPressureAltFactor;
        tempDeltaFunc = this.calculateBrakeEnergyTempDelta;
        windDeltaFunc = this.calculateBrakeEnergyWindDelta;
        break;
      case LimitingFactor.Vmcg:
        baseFactors = A330343TakeoffPerformanceCalculator.vmcgBaseFactor;
        slopeFactors = A330343TakeoffPerformanceCalculator.vmcgSlopeFactor;
        altFactors = A330343TakeoffPerformanceCalculator.vmcgPressureAltFactor;
  ...
  public calculateTakeoffPerformanceOptConf(
    ...
    const results = [1, 2, 3].map((conf, cacheIndex) =>
      this.calculateTakeoffPerformance(
        ...
        runwayCondition,
        cg,
        // A330343TakeoffPerformanceCalculator.optResultCache[cacheIndex],
      ),
    );
    ...
    if (filteredResults.length === 0) {
      return A330343TakeoffPerformanceCalculator.deepCopy(results[results.length - 1], out);
    }
    ...
    return A330343TakeoffPerformanceCalculator.deepCopy(filteredResults[0], out ?? {});
  }
  ...
  private calculateTvmcg(inputs: TakeoffPerformanceInputs, params: TakeoffPerformanceParameters): number {
    const factors: LerpVectorLookupTable = A330343TakeoffPerformanceCalculator.tvmcgFactors[inputs.conf];
    const [factor1, factor2] = factors.get(
      A330343TakeoffPerformanceCalculator.vec2Cache,
  ...
  private calculateTref(elevation: number): number {
    return A330343TakeoffPerformanceCalculator.tRefTable.get(elevation);
  }
  ...
  private calculateTmax(pressureAlt: number): number {
    return A330343TakeoffPerformanceCalculator.tMaxTable.get(pressureAlt);
  }
  ...
  private calculateTflexMax(isa: number): number {
    return isa + A330343TakeoffPerformanceCalculator.tMaxFlexDisa;
  }
  ...
  private calculateBaseRunwayPerfLimit(length: number, conf: number): number {
    switch (conf) {
      case 1:
        return A330343TakeoffPerformanceCalculator.runwayPerfLimitConf1.get(length);
      case 2:
        return A330343TakeoffPerformanceCalculator.runwayPerfLimitConf2.get(length);
      case 3:
        return A330343TakeoffPerformanceCalculator.runwayPerfLimitConf3.get(length);
      default:
        return NaN;
    }
  }
  ...
  private calculateRunwayTempDelta(
    ...
    const tempFactors = A330343TakeoffPerformanceCalculator.runwayTemperatureFactor[conf];
  ...
  private calculateSecondSegmentTempDelta(
    ...
    const tempFactors = A330343TakeoffPerformanceCalculator.secondSegmentTemperatureFactor[conf];
  ...
  private calculateBrakeEnergyTempDelta(
    ...
    const tempFactors = A330343TakeoffPerformanceCalculator.brakeEnergyTemperatureFactor[conf];
  ...
  private calculateVmcgTempDelta(
    ...
    const tempFactors = A330343TakeoffPerformanceCalculator.vmcgTemperatureFactor[conf];
  ...
  private calculateRunwayWindDelta(
    ...
    const windFactors =
      wind >= 0
        ? A330343TakeoffPerformanceCalculator.runwayHeadWindFactor[conf]
        : A330343TakeoffPerformanceCalculator.runwayTailWindFactor[conf];
  ...
  private calculateSecondSegmentWindDelta(
    ...
    const windFactors =
      wind >= 0
        ? A330343TakeoffPerformanceCalculator.secondSegmentHeadWindFactor[conf]
        : A330343TakeoffPerformanceCalculator.secondSegmentTailWindFactor[conf];
  ...
  private calculateBrakeEnergyWindDelta(
    ...
    const windFactors =
      wind >= 0
        ? A330343TakeoffPerformanceCalculator.brakeEnergyHeadWindFactor[conf]
        : A330343TakeoffPerformanceCalculator.brakeEnergyTailWindFactor[conf];
  ...
  private calculateVmcgWindDelta(
    ...
    if (wind >= 0) {
      const windFactors = A330343TakeoffPerformanceCalculator.vmcgHeadWindFactor[conf];
      ...
      const windFactors = A330343TakeoffPerformanceCalculator.vmcgTailWindFactor[conf];
  ...
  public isCgWithinLimits(cg: number, tow: number): boolean {
    const cgLimits = A330343TakeoffPerformanceCalculator.takeoffCgLimits.get(
      A330343TakeoffPerformanceCalculator.vec2Cache,
      tow,
    );
