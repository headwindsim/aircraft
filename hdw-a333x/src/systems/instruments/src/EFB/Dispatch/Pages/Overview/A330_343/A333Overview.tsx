...
import { A333NoseOutline } from '../../../../Assets/NoseOutline';
...
export const A333Overview = () => {
    ...
    return (
        <div className="h-content-section-reduced border-theme-accent mr-3 w-min overflow-hidden rounded-lg border-2 p-6">
            <h1 className="font-bold">Airbus A330-300</h1>
            <p>{airline}</p>

            <div className="mt-6 flex items-center justify-center">
                <A333NoseOutline className="text-theme-text flip-horizontal -ml-96 mr-32 h-64" />
            </div>
