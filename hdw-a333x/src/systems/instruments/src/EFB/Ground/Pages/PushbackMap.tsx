...
export const PushbackMap = () => {
    ...
    const aircraftWheelBase = getAirframeType() === 'A330_343' ? 25.38 : 12.64;
    const aircraftLengthMeter = getAirframeType() === 'A330_343' ? 62.89 : 37.57;
        ...
        <>
            ...
            >
                ...
                {!process.env.VITE_BUILD && (
                    <BingMap
                        configFolder="/Pages/VCockpit/Instruments/Airliners/Headwind_A339X/EFB/"
