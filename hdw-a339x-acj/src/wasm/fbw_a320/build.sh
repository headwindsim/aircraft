...
COMMON_DIR="${DIR}/../../../../a32nx/fbw-common/src/wasm/fbw_common"
OUTPUT="${DIR}/../../../../build-a339x/out/headwindsim-aircraft-a330-900/SimObjects/Airplanes/Headwind_ACJ330_900/panel/fbw.wasm"
