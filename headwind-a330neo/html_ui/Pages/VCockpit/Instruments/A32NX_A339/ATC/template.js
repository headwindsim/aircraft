...
class ATC_Logic extends BaseInstrument {
    constructor() {
        super();
    ...
    connectedCallback() {
        ...
        {
            const code = document.getElementById('ATC_BUNDLED_STYLE').innerHTML;
            const style = document.createElement('style');
            style.innerHTML = code;
            document.head.appendChild(style);
        }
        {
            const code = document.getElementById('ATC_BUNDLED_LOGIC').innerHTML;
...
registerInstrument('a32nx-atc', ATC_Logic);
