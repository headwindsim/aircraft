...
impl PumpCharacteristics {
    ...
    // Begin HDW A330 -- TO DO add correct values for A330
    const A330_EDP_DISPLACEMENT_BREAKPTS_PSI: [f64; 9] = [
        0.0, 500.0, 1000.0, 2900.0, 4790.0, 5150.0, 5225.0, 5350.0, 5500.0,
    ];
    const A330_EDP_DISPLACEMENT_MAP_CUBIC_INCH: [f64; 9] =
        [2.8, 2.8, 2.8, 2.8, 2.6, 0.00, 0.0, 0.0, 0.0];

    const A330_EPUMP_REGULATED_SPEED_RPM: f64 = 8000.0;

    const A330_EPUMP_DISPLACEMENT_BREAKPTS_PSI: [f64; 9] =
        [0., 2000., 3000., 4000., 5000., 5100., 5200., 5300., 5350.];

    const A330_EPUMP_DISPLACEMENT_MAP_CUBIC_INCH: [f64; 9] =
        [0.294525, 0.28875, 0.2858625, 0.231, 0.17325, 0., 0., 0., 0.];

    const A330_RAT_DISPLACEMENT_BREAKPTS_PSI: [f64; 9] = [
        0.0, 500.0, 1000.0, 1500.0, 2100.0, 2300.0, 2600.0, 2700.0, 3500.0,
    ];
    const A330_RAT_DISPLACEMENT_MAP_CUBIC_INCH: [f64; 9] =
        [0.5, 0.8, 1.15, 1.15, 1.15, 0.8, 0.3, 0.0, 0.0];
    // End HDW A330
    ...
    // Begin HDW A330
    pub fn a330_edp() -> Self {
        PumpCharacteristics::new(
            Self::A330_EDP_DISPLACEMENT_BREAKPTS_PSI,
            Self::A330_EDP_DISPLACEMENT_MAP_CUBIC_INCH,
            Self::AIR_PRESSURE_BREAKPTS_PSI,
            Self::AIR_PRESSURE_CARAC_RATIO,
            None,
        )
    ...
    pub fn a330_rat() -> Self {
        PumpCharacteristics::new(
            Self::A330_RAT_DISPLACEMENT_BREAKPTS_PSI,
            Self::A330_RAT_DISPLACEMENT_MAP_CUBIC_INCH,
            Self::AIR_PRESSURE_BREAKPTS_PSI,
            Self::AIR_PRESSURE_CARAC_RATIO,
            None,
        )
    ...
    pub fn a330_electric_pump() -> Self {
        PumpCharacteristics::new(
            Self::A330_EPUMP_DISPLACEMENT_BREAKPTS_PSI,
            Self::A330_EPUMP_DISPLACEMENT_MAP_CUBIC_INCH,
            Self::AIR_PRESSURE_BREAKPTS_PSI,
            Self::AIR_PRESSURE_CARAC_RATIO,
            Some(AngularVelocity::new::<revolution_per_minute>(
                Self::A330_EPUMP_REGULATED_SPEED_RPM,
            )),
        )
    }
    // Enfd HDW A330
