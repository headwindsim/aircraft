...
mod tests {
    ...
    /// A330 turbine TESTS
    #[test]
    fn a330_turbine_spins_in_high_air_speed_conditions() {
        let mut test_bed = SimulationTestBed::new(|context| {
            let turbine = a330_wind_turbine(context);
            TestAircraft::new(turbine)
        });
    ...
    #[test]
    fn a330_turbine_spins_in_medium_air_speed_conditions() {
        let mut test_bed = SimulationTestBed::new(|context| {
            let turbine = a330_wind_turbine(context);
            TestAircraft::new(turbine)
        });
    ...
    #[test]
    fn a330_turbine_fails_to_spin_in_min_air_speed_conditions_over_rated_load() {
        let mut test_bed = SimulationTestBed::new(|context| {
            let turbine = a330_wind_turbine(context);
            TestAircraft::new(turbine)
        });
    ...
    #[test]
    fn a330_turbine_spins_in_min_air_speed_conditions_at_lower_load() {
        let mut test_bed = SimulationTestBed::new(|context| {
            let turbine = a330_wind_turbine(context);
            TestAircraft::new(turbine)
        });
    ...
    #[test]
    fn a330_turbine_stalling_air_speed_conditions() {
        let mut test_bed = SimulationTestBed::new(|context| {
            let turbine = a330_wind_turbine(context);
            TestAircraft::new(turbine)
        });
    ...
    #[test]
    fn a330_turbine_stops_from_full_speed_less_than_5_s_more_than_2s() {
        let mut test_bed = SimulationTestBed::new(|context| {
            let turbine = a330_wind_turbine(context);
            TestAircraft::new(turbine)
        });
    ...
    #[test]
    fn a330_turbine_stops_from_full_speed_if_wind_less_than_30kts() {
        let mut test_bed = SimulationTestBed::new(|context| {
            let turbine = a330_wind_turbine(context);
            TestAircraft::new(turbine)
        });
    ...
    fn a330_wind_turbine(context: &mut InitContext) -> WindTurbine {
        WindTurbine::new(
            context,
