...
import { t, A330NoseOutline } from '@flybywiresim/flypad';
...
export const ACJ330Overview = () => {
    ...
    return (
        <div className="mr-3 h-content-section-reduced w-max overflow-hidden rounded-lg border-2 border-theme-accent p-6">
            <h1 className="font-bold">Airbus ACJ330neo</h1>
            <p>{airline}</p>
