        ...
        <div className="h-content-section-reduced border-theme-accent mr-3 w-min overflow-hidden rounded-lg border-2 p-6">
            ...
            <div className="mt-8 flex flex-row space-x-16">
                <div className="flex flex-col space-y-8">
                    <InformationEntry title={t('Dispatch.Overview.Model')} info={`${airframeInfo.variant} [${airframeInfo.icao}]`}>
                        <IconPlane className="fill-current" size={23} stroke={1.5} strokeLinejoin="miter" />
                    </InformationEntry>

                    <InformationEntry title={t('Dispatch.Overview.MZFW')} info={getConvertedInfo(airframeInfo.designLimits.weights.maxZfw, 'weight')}>
                        <Box size={23} />
                    </InformationEntry>
                ...
                <div className="flex flex-col space-y-8">
                    ...
                    <InformationEntry title={t('Dispatch.Overview.MTOW')} info={getConvertedInfo(airframeInfo.designLimits.weights.maxGw, 'weight')}>
                        <Box size={23} />
                    </InformationEntry>
                </div>
                <div className="flex flex-col space-y-8">
                    <InformationEntry title={t('Dispatch.Overview.Range')} info={getConvertedInfo(airframeInfo.designLimits.endurance.range, 'distance')}>
                        <Rulers size={23} />
                    </InformationEntry>

                    <InformationEntry title={t('Dispatch.Overview.MaximumCargo')} info={getConvertedInfo(airframeInfo.designLimits.weights.maxCargo, 'weight')}>
                        <Box size={23} />
                    </InformationEntry>
                </div>
                <div className="flex flex-col space-y-8">
                    ...
                    <InformationEntry title={t('Dispatch.Overview.MaximumFuelCapacity')} info={getConvertedInfo(airframeInfo.designLimits.weights.maxFuel, 'volume')}>
                        <Box size={23} />
                    </InformationEntry>
